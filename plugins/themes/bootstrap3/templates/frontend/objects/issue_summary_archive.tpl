 ...
 *}
<div class="issue-summary issue-archive-list">
	...
	{* Show cover image and use cover description *}
		<div class="media-left">
			<a class="cover" href="{url|escape op="view" path=$issue->getBestIssueId($currentJournal)}" title="{if $issueTitle}{$issueTitle|escape}{else}{$issueSeries|escape}{/if}">
