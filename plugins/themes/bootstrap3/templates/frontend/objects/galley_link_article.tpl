...
<div class="list-group-item text-center">
	...
	<em><div class="article_qrcode-title">{translate key="article.qr"}</div></em>
	<div id="article_qrcode{$qrcodeID}" class="article_qrcode"></div>
	<script>
		var qrcode = new QRCode("article_qrcode{$qrcodeID}");
		qrcode.makeCode("{url|escape page=$page op="view" path=$parentId|to_array:$galley->getBestGalleyId($currentJournal)}");
	</script>
</div>
