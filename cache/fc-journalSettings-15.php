...
al.</strong> El corrector/a de la revista editará el texto para mejorar la fluidez, claridad, gramática, vocabulario y formato del artículo, así como para incluir consultas al autor si es necesario. Una vez que la edición inicial se haya completado, el corrector/a cargará el documento revisado a través del sitio web de la revista y notificará al autor/a que el manuscrito editado está disponible para revisión.</li> <li><strong>Corrección del autor/a.</strong> Antes de realizar cambios radicales en la estructura y organización del manuscrito editado, los autores/as deben comprobarlos con los editores/as que codirigen la pieza. Los autores/as deben aceptar/rechazar cualquier cambio realizado durante la corrección inicial, según convenga, y responder a todas las consultas. Cuando se finalicen las revisiones, los autores/as deben cambiar el nombre del archivo de NombreAutorQA.doc a NombreAutorQAR.doc (p. ej., de LeeQA.doc a LeeQAR.doc) y cargar el documento revisado a través del sitio web de la revista siguiendo las instrucciones.</li> <li><strong>Corrección final.</strong> El corrector/a de la revista comprobará los cambios realizados por el autor/a e incorporará las respuestas a las consultas al autor para crear un manuscrito final. Cuando termine, el corrector/a cargará el documento final a través del sitio web de la revista y enviará una alerta al maquetista para completar el formateado.</li> </ol>',
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => 'O envio não tem sido publicado previamente nem se tem enviado previamente a outra revista (ou se tem proporcionado uma explicação em Comentários ao editor).',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => 'O ficheiro enviado está em formato Microsoft Word e este não possui em seu interior o(s) nome(s) do autor ou autores do artigo.',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => 'S<span style="line-height: 200%; text-align: justify; text-indent: -18pt;" lang="PT-BR"><span style="font-stretch: normal; font-size: 7pt; line-height: normal; font-family: \'Times New Roman\';"> </span></span><span style="line-height: 200%; text-align: justify; text-indent: -18pt;" lang="PT-BR">e têm acrescentado endereços web para as referências onde tem sido possível.</span>',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => 'O texto tem espaçamento a espaço e meio; o tamanho da fonte Times é 12 pontos; se utiliza itálica em vez de sublinhado (exceptuando os endereços URL); e todas as ilustrações, figuras e tabelas estão dentro do texto no lugar que lhes corresponde e não no fim, e tem entre 4000 e 9000 palavras.',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'O artigo que deseja enviar à revista cumpre com as  <a href="/index.php/disertaciones/about/submissions#authorGuidelines" target="_blank">normas para autores/ras</a> expostas na seção acerca da revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'Se está enviando a uma seção da revista que se revisa por pares, tem que se assegurar que as instruções em <em><span style="text-decoration: underline;">Asegurando de una revisión a ciegas</span></em> tenham sido seguidas.',
      ),
      6 => 
      array (
        'order' => '7',
        'content' => 'Ao fazer o envio deste manuscrito e, no caso de ser aprovado, autorizamos ao Anuário Eletrônico de Estudos em Comunicação Social “Disertaciones” a publicar o artigo e reproduzi-lo pelos meios que considere convenientes (Internet, impresso, etc.).',
      ),
    ),
    'en_US' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => 'The submission has not been previously published nor submitted to any other journal (or an explanation has been provided in the Comments to the Editor).',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => 'The file will be sent in the Microsoft Word format and does not contain the name of the author or authors.',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => 'Web addresses have been provided for references whenever possible.',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => 'Line spacing in the body of the text is 1.5; the font is 12-point Times New Roman. Apart from URL addresses, italics are used rather than underlining. All illustrations, figures, and tables are within the text in the most appropriate place, not at the end. The manuscript has a total of 4,000 to 9,000 words.',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'The manuscript conforms to the <a href="/index.php/disertaciones/about/submissions#authorGuidelines" target="_blank">guidelines for authors</a> found in the section that describes the journal.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'If you are submitting a manuscript to a section of the journal that is peer-reviewed, be sure that you have followed the instructions in <span style="text-decoration: underline;">Ensuring a Blind Review</span>.',
      ),
      6 => 
      array (
        'order' => '7',
        'content' => 'By submitting this manuscript, and if it is approved, we authorize <em>Disertaciones</em>:<em> the Electronic Annual of Studies in Social Communication</em> to publish the article and reproduce it using the media that it chooses (Internet, print, etc.).',
      ),
    ),
  ),
  'rtAbstract' => true,
  ...
  'submissionFeeName' => 
  array (
    'es_ES' => 'Enviar un artículo',
  ),
  'submissionFeeDescription' => 
  array (
    'es_ES' => 'Los autores deben pagar una cuota de envío de artículo como parte del proceso de envío para contribuir con los costes de revisión.',
  ),
  'fastTrackFee' => 0,
  'fastTrackFeeName' => 
  array (
  ...
  array (
    'es_ES' => 'Con el pago de esta cuota, se garantiza que la revisión, la decisión editorial y la notificación al autor del manuscrito tendrán lugar dentro de un plazo de 4 semanas.',
  ),
  'publicationFee' => 0,
  'publicationFeeName' => 
  array (
    'es_ES' => 'Publicar un artículo',
  ),
  'publicationFeeDescription' => 
  array (
    'es_ES' => 'Si se acepta la publicación del artículo, se le pedirá el pago de una cuota de publicación de artículo para cubrir los costes de publicación.',
  ),
  'waiverPolicy' => 
  array (
    'es_ES' => 'En caso de no disponer de fondos para pagar dicha cuota, existe la posibilidad de eximirse del pago. El impago de las cuotas no impedirá la publicación de aquellas obras que lo merezcan.',
  ),
  'purchaseArticleFee' => 0,
  'purchaseArticleFeeName' => 
  array (
    'es_ES' => 'Comprar un artículo',
  ),
  'purchaseArticleFeeDescription' => 
  array (
    'es_ES' => 'El pago de esta cuota le permitirá visualizar, descargar e imprimir el artículo.',
  ),
  'membershipFee' => 0,
  'membershipFeeName' => 
  array (
  ...
  array (
    'es_ES' => 'El pago de esta cuota garantiza el alta como miembro de la asociación durante un año y le proporciona acceso gratuito a la revista.',
  ),
  'donationFeeName' => 
  array (
  ...
  array (
    'es_ES' => 'Toda donación será gratamente recibida y se empleará en proporcionar recursos a los editores para seguir ofreciendo a los lectores una revista de alta calidad.',
  ),
  'metaCitations' => true,
  'supportedLocales' => 
  array (
  ...
  'name' => 
  array (
    'es_ES' => 'Anuario electrónico de estudios en Comunicación Social "Disertaciones"',
  ...
  'printIssn' => '',
  'onlineIssn' => '1856-9536',
  'mailingAddress' => '<p><a href="https://www.google.es/maps/search/Universidad+del+rosario+-+Carrera+6,+Bogot%C3%A1,+Colombia/@4.6001485,-74.0737921,20z" target="_blank">Calle 12C No. 6-25</a><span> - Bogotá D.C. Colombia</span></p>',
  'categories' => NULL,
  'useEditorialBoard' => false,
  'contactName' => 'Carlos Arcila',
  'contactEmail' => 'disertaciones@urosario.edu.co',
  'contactPhone' => '',
  'contactFax' => '',
  'supportName' => 'Carlos Arcila',
  'supportEmail' => 'disertaciones@urosario.edu.co',
  'supportPhone' => '',
  'publisherInstitution' => 'Universidad del Rosario / Universidad de Los Andes / Universidad Complutense de Madrid',
  'publisherUrl' => '',
  'publisherNote' => 
  array (
    'es_ES' => 'El ANUARIO es editado por la Universidad del Rosario de Colombia, en colaboración con la Universidad de los Andes de Venezuela (<a href="http://saber.ula.ve/handle/123456789/26076" target="_blank">Departamento de Comunicación Social de la ULA Táchira,</a> <a href="http://www.human.ula.ve/gruinco" target="_blank">Grupo de Investigación Comunicación, Cultura y Sociedad</a> y <a href="http://saber.ula.ve/items-by-subject?subject=Laboratorio+de+Investigaci%C3%B3n+Educativa+Sim%C3%B3n+Rodr%C3%ADguez+%28LIESR%29" rel="nofollow" target="_blank">Laboratorio de Investigación Educativa Simón Rodríguez (LIESR)</a>) y la Universidad Complutense de Madrid de España (<a href="http://www.ucm.es/info/mdcs/" target="_blank">Grupo Mediación Dialéctica de la Comunicación Social MDCS</a>).',
    'en_US' => 'The journal is edited by the Universidad del Rosario (Colombia), in collaboration with the Universidad de los Andes from Venezuela (<a href="http://saber.ula.ve/handle/123456789/26076" target="_blank">Departamento de Comunicación Social de la ULA Táchira,</a> <a href="http://www.human.ula.ve/gruinco" target="_blank">Grupo de Investigación Comunicación, Cultura y Sociedad</a> &amp; <a href="http://saber.ula.ve/items-by-subject?subject=Laboratorio+de+Investigaci%C3%B3n+Educativa+Sim%C3%B3n+Rodr%C3%ADguez+%28LIESR%29" rel="nofollow" target="_blank">Laboratorio de Investigación Educativa Simón Rodríguez (LIESR)</a>) and the Universidad Complutense de Madrid from Spain (<a href="http://www.ucm.es/info/mdcs/" target="_blank">Grupo Mediación Dialéctica de la Comunicación Social MDCS</a>).',
  ),
  'envelopeSender' => '',
  'searchDescription' => 
  array (
  ...
  'searchKeywords' => 
  array (
    'es_ES' => 'Comunicación; estudios; investigación; social; anuario',
  ),
  ...
  'reviewGuidelines' => 
  array (
    'es_ES' => 'Todos los artículos serán seleccionados bajo alto rigor científico, por su originalidad, relevancia del tema y aportaciones en el área de la comunicación. Se tomará como consideraciones fundamentales que el articulo responda a una brecha debidamente argumentada de conocimiento en el campo y que los métodos utilizados para la recolección y análisis de los datos cumplan con estándares de calidad.',
  ),
  ...
  array (
    ...
    array (
      'name' => 'Logof.png',
      'uploadName' => 'pageHeaderTitleImage_es_ES.png',
      'width' => 305,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpwxKwHY\' (No such file or directory)',
      'dateUploaded' => '2015-07-02 22:05:09',
    ),
  ),
  ...
  'copySubmissionAckAddress' => 'disertaciones@urosario.edu.co',
  ...
  'authorGuidelines' => 
  array (
    'es_ES' => '<p align="center"><strong>Normas para autores/as</strong></p><p><em> </em><strong>Características de las contribuciones y artículos recibidos</strong></p><p>Disertaciones es una revista académica y científica, de acceso abierto en Internet, que publica aportes originales y relevantes en el campo de la comunicación social, específicamente en las líneas de: (i) Sociedad y Tecnologías de la Información y la Comunicación; (ii) Comunicación y Política; (iii) Periodismo; y (iv) Comunicación y Cultura.</p><p>La revista recibe artículos escritos en español, inglés y portugués <strong>sin ningún costo para los autores</strong>. Todos los artículos propuestos a Disertaciones deben ser de carácter inédito, por lo cual no se aceptarán trabajos que hayan sido publicados previamente, ya sea en medio impreso o en Internet, o que se encuentren en proceso de evaluación en otra publicación.</p><p>El contenido de la revista está organizado en cuatro secciones: <em>Estudios</em>, <em>Avances,</em> <em>Ensayos</em>, <em>Reseñas</em>. </p><p>Disertaciones tiene como eje principal la publicación de artículos de investigación, originales e inéditos, cuyos resultados contribuyan al avance del conocimiento científico en el campo de la comunicación. Estos artículos son editados en las secciones <em>Estudios </em>y  <em>Avances</em>.</p><p>La sección <em>Estudios</em>, de carácter monográfico,<em> </em>reúne los artículos especializados que aportan al dosier temático específico convocado para cada número de la revista.</p><p>La sección <em>Avances, </em>publica artículos de tema abierto de investigación en comunicación, que aporten al conocimiento sobre las líneas temáticas generales de la revista.</p><p>En la sección <em>Ensayos</em> se publican artículos de reflexión que, derivados de experiencias de investigación o de una sólida revisión crítica de la literatura académica pertinente y actualizada, hagan una aportación original al debate teórico o metodológico sobre el tema central de cada número de la revista</p><p>La revista también publica reseñas críticas de libros o eventos académicos destacados y recientes relacionados con los estudios en comunicación. Estos textos son editados en la sección <em>Reseñas.</em> </p><ul><li>Los artículos recibidos a Disertaciones, antes de ser enviados a pares evaluadores, serán revisados inicialmente por un equipo del consejo de redacción de la revista con el fin de verificar que cumplan efectivamente con las presentes normas para los autores. En este proceso la revista somete los manuscritos recibidos a un software que coteja el nivel de originalidad del texto y el adecuado manejo de citaciones.<strong> </strong></li></ul><p><strong><br /></strong></p><p><strong>Parámetros de presentación de artículos (secciones Estudios, Avances, Ensayos)</strong><em> </em></p><ul><li>Los artículos deberán presentarse en formato Word (.doc o .docx), escritos en fuente Times New Roman de 12 puntos, a espacio y medio, página tamaño carta con márgenes de 2,5 cm, y paginado en el ángulo derecho superior. Las notas a pie de página, las cuales serán utilizadas solo para realizar aclaraciones pertinentes y comentarios adicionales al texto central, se numeran consecutivamente y escriben en fuente Times New Roman de 10 puntos. Las referencias bibliográficas irán al final del artículo, ordenadas alfabéticamente y siguiendo las normas de estilo de la Asociación Psicológica Americana (APA), en su más reciente versión (sexta en inglés, tercera en español traducida de la versión sexta en inglés). </li></ul><ul><li>La extensión de los artículos (publicados en las secciones Estudios, Avances y Ensayos) será mínimo de 4000 palabras y máximo de 9000 palabras, incluyendo el resumen, notas al pie y referencias bibliográficas. </li></ul><ul><li>En el contenido del artículo no se deben incluir datos o referencias que identifiquen a los autores del texto enviado. Para registrar dichos datos se debe adjuntar otro archivo en Word que contenga para cada uno de los autores: nombres y apellidos, formación académica, filiación institucional, principales líneas de investigación y dirección de correo electrónico. Asimismo, en este archivo anexo se deberá registrar la información sobre el origen del trabajo presentado: Proyecto de investigación del cual se deriva el artículo, así como el crédito que corresponda a las instituciones que apoyaron la realización del proyecto. </li></ul><ul><li>Cada artículo irá precedido por el título, que debe ser conciso sobre el objeto  y alcance del texto, y un resumen que sintetice, en un párrafo de máximo 200 palabras, los elementos centrales del trabajo, destacando las tesis o argumentos centrales, resultados, aportes y conclusiones más relevantes. Tanto el título como el resumen deben ser presentados en el idioma original del artículo y ser traducidos al inglés (o al español si el artículo es escrito en inglés). </li></ul><ul><li>Tras el resumen se deben incorporar entre tres y cinco palabras claves que permitan identificar el contenido del artículo. Igualmente, estas palabras deberán estar en el idioma original del artículo y ser traducidas al inglés (<em>keywords</em>), o al español si el cuerpo del trabajo está escrito en inglés. </li></ul><ul><li>Los artículos de investigación, publicados en las secciones Estudios y Avances, deben estar organizados siguiendo en términos generales la estructura convencional de los trabajos científicos, particularmente en ciencias sociales: Introducción, antecedentes o estado de la cuestión, metodología, resultados, discusión y conclusiones. Se espera que la estructura específica mediante la cual se desarrolla cada artículo sea apropiada y consistente con la perspectiva teórico-metodológica del estudio realizado. </li></ul><ul><li>Todos los artículos deben tener secciones tituladas o subtítulos, de acuerdo a la estructura del texto. Sin embargo, la introducción del artículo no va precedida de un título que la designe como tal, pues se asume que la primera parte del manuscrito corresponde a la introducción. Para las demás secciones y subsecciones del artículo se utilizarán  niveles de títulos y subtítulos, sin letras o números, dependiendo de la jerarquización de la información del trabajo. Si bien la mayoría de la estructura de los artículos de investigación tienen por lo general hasta tres niveles de títulos, la revista utiliza una adaptación del estilo APA de encabezados, que ofrece hasta cinco niveles de subordinación en el formato de los títulos: </li></ul><p>Tabla 1 Formato para jerarquización de niveles de títulos y subtítulos</p><table border="0" cellspacing="0" cellpadding="0"><tbody><tr><td valign="top" width="110"><p align="center"><strong>Nivel de título</strong></p></td><td valign="top" width="431"><p><strong>Formato</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">1</p></td><td valign="top" width="431"><p align="center"><strong>Título de sección en negritas centrado</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">2</p></td><td valign="top" width="431"><p><strong>Subtítulo en negritas, alineado a la izquierda</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">3</p></td><td valign="top" width="431"><p>    <strong>Subtítulo de párrafo con sangría y negritas </strong></p></td></tr><tr><td valign="top" width="110"><p align="center">4</p></td><td valign="top" width="431"><p>       <strong><em>Subtítulo de párrafo con sangría, en negritas y cursiva </em></strong></p></td></tr><tr><td valign="top" width="110"><p align="center">5</p></td><td valign="top" width="431"><p>          <em>Subtítulo de párrafo con sangría y cursiva</em></p></td></tr></tbody></table><p>Adaptado del  Manual de Publicaciones de la APA, tercera edición en español traducida de la sexta versión en inglés. </p><p>Únicamente deben emplearse los niveles de título que sean necesarios según los apartados y sub apartados del texto presentado. Así, el artículo podrá estructurarse solo con títulos de sección, para lo cual debe emplear solo el nivel de título 1 o podrá tener hasta 5 niveles de subsecciones y emplear para cada una de ellas los niveles de título respectivos. </p><ul><li>Si el artículo incluye figuras y tablas estas deben ser numeradas con números arábigos, en  orden correlativo a cómo se mencionan en el texto. Las tablas deben entregarse incorporadas en formato de tabla de Word al mismo archivo en el que se presenta el artículo. Igualmente las figuras y fotografías deben estar incorporadas al archivo de Word, y adicionalmente adjuntarlas como archivos anexos en formato JPG. Cada tabla incorporada al artículo debe llevar un título descriptivo en la parte superior y  las leyendas de las figuras deben ser lo suficientemente explicativas. Al pie de la tabla se registran las notas aclaratorias, así como el crédito a la fuente de datos. Se debe evitar la utilización de líneas verticales en las tablas, procurando presentar de la manera más clara posible los datos al lector. Para recomendaciones más detalladas de presentación de las tablas y figuras consultar el capítulo 5 del  Manual de publicaciones de la APA. </li></ul><ul><li>Para una exposición detallada del conjunto de datos y resultados de la investigación, ya sean cuantitativos o cualitativos, se recomienda la utilización de archivos en línea complementarios. Si el autor requiere la utilización de visualizaciones especiales para la presentación de datos, como gráficos, videos o tablas interactivas, la revista hará las gestiones para incorporar estos formatos. </li></ul><ul><li>La revista sugiere a sus autores el envío del conjunto de datos en bruto de la investigación y el libro de códigos utilizado con el fin de fortalecer la rigurosidad y comunicabilidad del aporte investigativo, dando la posibilidad de la replicación y confrontación de los resultados por otros investigadores. Este envío es opcional. </li></ul><ul><li>Las propuestas de artículos a Disertaciones se recibirán a través del sistema en línea de recepción de textos a evaluar por la revista, disponible en la página web: <a href="/index.php/disertaciones/">http://revistas.urosario.edu.co/index.php/disertaciones/</a> </li></ul><p><em> </em></p><p><strong>Normas de estilo y citación de referencias</strong></p><p>En cuanto a las normas de estilo, citación y referencias bibliográficas, los artículos propuestos a la revista deben prepararse siguiendo el manual de publicaciones de la APA (en su sexta versión en inglés y tercera en español, la cual corresponde a la traducción oficial de la versión sexta en inglés). </p><p>Se retoma aquí una síntesis general de las normas de estilo y citación que son más comúnmente empleadas en los artículos de investigación: </p><ul><li>Las abreviaturas referidas a conceptos y términos técnicos se usarán solo si resultan estrictamente necesarias. Los términos abreviados, así como las siglas y acrónimos, se deben escribir completos la primera vez que aparecen e inmediatamente después como abreviatura entre paréntesis.  </li></ul><ul><li>Para el reporte de datos estadísticos las fórmulas solo deben utilizarse cuando estas resultan esenciales para el artículo o cuando se presenta una expresión matemática o estadística nueva, no para la presentación de un dato estadístico de uso común. Preferiblemente, las ecuaciones se deben presentar en formato editable en el procesador de palabras y no en formato de imagen. Sobre detalles específicos para la presentación de material estadístico y matemático en el artículo consultar el capítulo 4 del manual de estilo de publicaciones de la APA.  </li></ul><ul><li>Las citas textuales y paráfrasis se deben referir en el cuerpo del texto siguiendo las normas APA (autor, año, página de la cita). Cuando se utilicen citas textuales menores de 40 palabras se incorporan directamente al texto entrecomilladas, y después de cerrar comillas se registra entre paréntesis a la fuente. Las citas textuales mayores de 40 palabras deben ir en párrafo aparte, con sangría en el margen izquierdo de 2,5 cm  y sin entrecomillar. Después del signo de puntación final de la cita se debe referir la fuente entre paréntesis. </li></ul><ul><li>Al final del artículo, bajo el encabezado de Referencias bibliográficas, se debe listar en orden alfabético únicamente la lista de referencias que realmente hayan sido utilizadas y citadas en el cuerpo del texto. Para la elaboración de las citaciones y el listado de referencias debe seguirse las normas APA, ya sea en la sexta edición en inglés o la traducción oficial al español (tercera edición), dependiendo del idioma  en el cual esté escrito el artículo.  </li></ul><ul><li>Sobre dudas específicas de citación de las fuentes, se recomienda a los autores consultar, además de los manuales de estilo referidos, el sitio en internet de las normas de estilo APA en inglés (<a href="http://www.apastyle.org/">www.apastyle.org</a>)</li></ul><p> </p><p><strong>Lineamientos generales para la presentación de reseñas de libros y eventos académicos</strong><strong> </strong></p><ul><li>Las reseñas tendrán una extensión máxima de 1500 palabras y deben ser presentadas en archivo Word, siguiendo el formato de fuente, espaciado y márgenes referido en los requerimientos de presentación de artículos para la revista. En el mismo archivo se deben registrar los datos identificatorios del autor de la reseña: nombre y apellidos, filiación institucional y líneas de investigación.<strong> </strong></li></ul><ul><li>Si se trata de una reseña de libro, al final del texto se deben incluir los datos bibliográficos completos de la obra reseñada: autor, fecha, título completo, ciudad, editorial, número de páginas. Si se trata de la reseña de un evento académico se debe referir: nombre del evento, instituciones organizadoras, lugar y fecha de realización.<strong> </strong></li></ul><ul><li>El libro objeto de la reseña debe haber sido publicado en los dos últimos años y constituir una clara aportación a la investigación en comunicación. Si se trata de la reseña de un evento académico este debe haber sido realizado durante el último año y ser un acontecimiento de notable relevancia internacional para los estudios en comunicación. No necesariamente el libro o evento reseñado tiene que estar directamente relacionado con el monográfico del número de la revista al cual se envía la reseña.<strong> </strong></li></ul><ul><li>Quien realice la reseña propuesta a la revista no debe haber participado como editor o coautor del libro reseñado, o ser parte del comité académico del evento objeto del texto. Es recomendable que el autor de la reseña tenga una trayectoria académica reconocida en torno al tema o área específica en la que se inscribe el libro o evento referido.<strong> </strong></li></ul><ul><li>Se espera que las reseñas de libros propuestas a la revista trasciendan el plano meramente descriptivo y ofrezcan una perspectiva crítica y constructiva, que permita identificar los alcances y limitaciones de la obra, destacando la pertinencia de sus aportes al área específica en la cual se inscribe en el campo de los estudios en comunicación.<strong> </strong></li></ul><ul><li>Para citaciones directas del libro reseñado se hará referencia entre paréntesis a la página de donde se toma la cita. Para citaciones de otras obras en el cuerpo de la reseña se utilizarán las normas APA. <strong></strong></li></ul>',
    'pt_BR' => '<p><strong>Normas para autores</strong></p><p><em> </em></p><p><strong>Características das contribuições e artigos recebidos </strong></p><p><em>Disertaciones </em>é uma revista acadêmica e científica, de acesso aberto na internet, que publica aportes originais e relevantes no campo da comunicação social, especificamente nas linhas de: (i) Sociedade e Tecnologias da Informação e a Comunicação; (ii) Comunicação e Política; (iii) Jornalismo; e (iv) Comunicação e Cultura.</p><p> </p><p>A revista recebe artigos escritos em espanhol, inglês e português. Todos os artigos propostos a <em>Disertaciones</em> devem ser de caráter inédito, pelo qual não se aceitarão trabalhos que tenham sido publicados previamente, seja em meio impresso ou na internet, ou que se encontre em processo de avaliação em outra publicação.</p><p>O conteúdo da revista está organizado em quatro seções: Estudos, Avanços, Ensaios, Resenhas. </p><p> </p><p><em>Disertaciones</em> tem como objetivo principal a publicação de artigos de investigação, originais e inéditos, cujos resultados contribuam ao avanço do conhecimento científico no campo da comunicação. Estes artigos são editados nas seções <em>Estudos </em>e <em>Avanços</em>.</p><p> </p><p>A seção <em>Estudos</em>, de caráter monográfico, reúne os artigos especializados que aportam ao dossiê temático específico convocado para cada número da revista.</p><p> </p><p>A seção <em>Avanços</em>, publica artigos de tema aberto de investigação em comunicação, que aportem ao conhecimento sobre as linhas temáticas gerais da revista.</p><p> </p><p>Na seção <em>Ensaios </em>se publicam artigos de reflexão que, derivados de experiências de investigação ou de uma sólida revisão crítica da literatura acadêmica pertinente e atualizada, façam uma contribuição original ao debate teórico ou metodológico sobre o tema central de cada número da revista</p><p>A revista também publica resenhas críticas de livros ou eventos acadêmicos destacados e recentes relacionados com os estudos em comunicação. Estes textos são editados na seção <em>Resenhas.</em></p><p><strong> </strong></p><ul><li>Os artigos recebidos por <em>Disertaciones</em>, antes de ser enviados a pares avaliadores, serão revisados inicialmente por uma equipe do conselho de redação da revista com o fim de verificar que cumpram efetivamente com as presentes normas para os autores. Neste processo a revista submete os manuscritos recebidos a um software que coteja o nível de originalidade do texto e a adequada gestão de citações.</li></ul><p><em> </em></p><p><strong> </strong></p><p><strong>Parâmetros de apresentação de artigos (seções Estudos, Avanços, Ensaios)</strong></p><p><em> </em></p><ul><li>Os artigos deverão apresentar-se em formato Word (.doc ou .docx), escritos em fonte Times New Roman de 12 pontos, a espaço e meio, página tamanho carta com margens de 2,5 cm, e paginado no ângulo direito superior. As notas ao pé da página, as quais serão utilizadas só para realizar aclarações pertinentes e comentários adicionais ao texto central, numeram-se consecutivamente e escrevem em fonte Times New Roman de 10 pontos. As referências bibliográficas irão no fim do artigo, ordenadas alfabeticamente e seguindo as normas de estilo da Associação Psicológica Americana (APA), em sua mais recente versão (sexta em inglês, terceira em espanhol traduzida da sexta versão em inglês).</li></ul><p> </p><ul><li>A extensão dos artigos (publicados nas seções Estudos, Avanços e Ensaios) será mínimo de 4000 palavras e máximo de 9000 palavras, incluindo o resumo, notas ao pé e referências bibliográficas</li></ul><p> </p><ul><li>No conteúdo do artigo não se devem incluir dados ou referências que identifiquem aos autores do texto enviado. Para registar ditos dados deve-se anexar outro ficheiro em Word que contenha para cada um dos autores: nomes e sobrenomes, formação acadêmica, filiação institucional, principais linhas de investigação e endereço de correio eletrônico. Igualmente, neste ficheiro anexo deverá registrar a informação sobre a origem do trabalho apresentado: Projeto de investigação do qual se deriva o artigo, assim como o crédito que corresponda às instituições que apoiaram a realização do projeto.</li></ul><p> </p><ul><li>Cada artigo irá precedido pelo título, que deve ser conciso sobre o objeto e alcance do texto, e um resumo que sintetize, em um parágrafo de máximo 200 palavras, os elementos centrais do trabalho, destacando as teses ou argumentos centrais, resultados, aportes e conclusões mais relevantes. Tanto o título como o resumo devem ser apresentados na língua original do artigo e ser traduzidos ao inglês (ou ao espanhol se o artigo é escrito em inglês).</li></ul><p> </p><ul><li>Depois do resumo se devem incorporar entre três e cinco palavras-chave que permitam identificar o conteúdo do artigo. Igualmente, estas palavras deverão estar na língua original do artigo e ser traduzidas ao inglês (<em>keywords</em>), ou ao espanhol se o corpo do trabalho está escrito em inglês.</li></ul><p> </p><ul><li>Os artigos de investigação publicados nas seções Estudos e Avanços, devem estar organizados seguindo em termos gerais a estrutura convencional dos trabalhos científicos, particularmente em ciências sociais: Introdução, antecedentes ou estado da questão, metodologia, resultados, discussão e conclusões. Espera-se que a estrutura específica mediante a qual se desenvolve cada artigo seja apropriada e consistente com a perspectiva teórico-metodológica do estudo realizado.</li></ul><p> </p><ul><li>Todos os artigos devem ter seções tituladas ou subtítulos, de acordo à estrutura do texto. No entanto, a introdução do artigo não vai precedida de um título que a designe como tal, pois assume-se que a primeira parte do manuscrito corresponde à introdução. Para as demais seções e subseções do artigo se utilizarão níveis de títulos e subtítulos, sem letras ou números, dependendo da hierarquização da informação do trabalho. Se bem a maioria da estrutura dos artigos de investigação tem pelo geral até três níveis de títulos, a revista utiliza uma adaptação do estilo APA de cabeçalhos, que oferece até cinco níveis de subordinação no formato dos títulos:</li></ul><p> </p><p> </p><p>Tabela 1 Formato para hierarquização de níveis de títulos e subtítulos</p><table border="0" cellspacing="0" cellpadding="0"><tbody><tr><td valign="top" width="110"><p><strong>Nível de título</strong></p></td><td valign="top" width="431"><p><strong>Formato</strong></p></td></tr><tr><td valign="top" width="110"><p>1</p></td><td valign="top" width="431"><p><strong>Título de seção em negrito centrado</strong></p></td></tr><tr><td valign="top" width="110"><p>2</p></td><td valign="top" width="431"><p><strong>Subtítulo em negrito, alinhado à esquerda</strong></p></td></tr><tr><td valign="top" width="110"><p>3</p></td><td valign="top" width="431"><p>    <strong>Subtítulo de parágrafo com recuo e negrito </strong></p></td></tr><tr><td valign="top" width="110"><p>4</p></td><td valign="top" width="431"><p>       <strong><em>Subtítulo de parágrafo com recuo, em negrito e itálico </em></strong></p></td></tr><tr><td valign="top" width="110"><p>5</p></td><td valign="top" width="431"><p>          <em>Subtítulo de parágrafo com recuo e itálico </em></p></td></tr></tbody></table><p>Adaptado do Manual de Publicações da APA, terceira edição em espanhol traduzida da sexta versão em inglês.</p><p> </p><p>Unicamente devem empregar-se os níveis de título que sejam necessários segundo as seções e subseções do texto apresentado. Assim o artigo poderá estruturar-se só com títulos de seção para o qual deve empregar só o nível de título 1 ou poderá ter até 5 níveis de subseções e empregar para cada uma delas os níveis de título respectivos.</p><p> </p><ul><li>Se o artigo inclui figuras e tabelas estas devem ser enumeradas com números arábigos, em ordem correlativa a como se mencionam no texto. As tabelas devem entregar-se incorporadas em formato de tabela de Word no mesmo ficheiro em que se apresenta o artigo. Igualmente as figuras e fotografias devem estar incorporadas ao ficheiro de Word, e adicionalmente anexadas como elementos adicionais em formato JPG. Cada tabela incorporada ao artigo deve levar um título descritiva na parte superior e as legendas das figuras devem ser suficientemente explicativas. Ao pé da tabela se registram as notas esclarecedoras, assim como o crédito à fonte de dados. Deve-se evitar a utilização de linhas verticais nas tabelas, procurando apresentar da maneira mais clara possível os dados ao leitor. Para recomendações mais detalhadas de apresentação das tabelas e figuras consultar o capítulo 5 do Manual de Publicações da APA.</li></ul><p> </p><ul><li>Para uma exposição detalhada do conjunto de dados e resultados da pesquisa, sejam quantitativos ou qualitativos, recomenda-se a utilização de arquivos on-line complementários. Se o autor requere a utilização de visualizações especiais para a apresentação de dados, como gráficos, vídeos ou tabelas interativas, a revista fará as gestões para incorporar estes formatos.</li></ul><p> </p><ul><li>A revista sugere aos seus autores o envio do conjunto de dados em bruto da investigação e o livro de códigos utilizado com o fim de fortalecer a rigorosidade e comunicabilidade da contribuição investigativa, dando a possibilidade da replicação e confrontação dos resultados por outros investigadores. Este envio é opcional.</li></ul><p> </p><ul><li>As propostas de artigos a <em>Disertaciones</em> se receberão através do sistema on-line de recepção de textos a avaliar pela revista, disponível no site: <a href="/index.php/disertaciones/">http://revistas.urosario.edu.co/index.php/disertaciones/</a></li></ul><p> </p><p> </p><p><em> </em></p><p><strong>Normas de estilo e citação de referências</strong></p><p>Em quanto às normas de estilo, citação e referências bibliográficas, os artigos propostos à revista devem preparar-se seguindo o manual de publicações da APA (na sua sexta versão em inglês e terceira em espanhol, a qual corresponde à tradução oficial da versão sexta em inglês).</p><p> </p><p>Retoma-se aqui uma síntese geral das normas de estilo e citação que são mais comumente empregadas nos artigos de investigação:</p><p> </p><ul><li>As abreviaturas referidas a conceitos e termos técnicos se utilizarão só se resultam estritamente necessárias. Os termos abreviados, assim como as siglas e acrónimos, devem-se escrever completos a primeira vez que aparecem e imediatamente depois como abreviatura entre parêntesis.</li></ul><p> </p><ul><li>Para o reporte de dados estadísticos as fórmulas só devem se utilizar quando estas resultam essenciais para o artigo ou quando se apresenta uma expressão matemática ou estatística nova, não para a apresentação de um dado estatístico de uso comum. Preferivelmente, as equações se devem apresentar em formato editável no processador de palavras e não em formato de imagem. Sobre detalhes específicos para a apresentação de material estatístico e matemático no artigo consultar o capítulo 4 do manual de estilo de publicações da APA.</li></ul><p> </p><ul><li>As citas textuais e paráfrase se devem referir no corpo do texto seguindo as normas APA (autor, ano, página da cita). Quando se utilizem citas textuais menores de 40 palavras se incorporam diretamente ao texto entre aspas e depois de fechar aspas se registra entre parêntesis a fonte. As citas textuais maiores de 40 palavras devem ir em parágrafo aparte com recuo na margem esquerda de 2,5 cm e sem estar entre aspas. Depois do signo de pontuação final da cita deve-se referir a fonte entre parêntesis.</li></ul><p> </p><ul><li>No fim do artigo, debaixo do cabeçalho de Referências bibliográficas, deve-se listar em ordem alfabética unicamente a lista de referências que realmente tenham sido utilizadas e citadas no corpo do texto. Para a elaboração das citações e o listado de referências deve seguir-se as normas APA, seja na sexta edição em inglês, seja na tradução oficial ao espanhol (terceira edição), dependendo da língua no qual esteja escrito o artigo.</li></ul><p> </p><ul><li>Sobre dúvidas específicas de citação das fontes, recomenda-se aos autores consultar, para além dos manuais de estilo referidos, o site na internet das normas de estilo APA em inglês (<a href="http://www.apastyle.org/">www.apastyle.org</a>)</li></ul><p> </p><p><strong>Lineamentos gerais para a apresentação de resenhas de livros e eventos acadêmicos</strong></p><p><strong> </strong></p><ul><li>As resenhas terão uma extensão máxima de 1500 palavras e devem ser apresentadas em ficheiro Word, seguindo o formato de fonte, espaçamento e margens referido nos requerimentos de apresentação de artigos para a revista. No mesmo ficheiro devem-se registrar os dados de identificação do ator da resenha: nome e sobrenome, filiação institucional e linhas de investigação.</li></ul><p> </p><ul><li>Se se trata de uma resenha de livro, no final do texto devem-se incluir os dados bibliográficos completos da obra resenhada: autor, data, título completo, cidade, editorial, número de páginas. Se se trata da resenha de um evento acadêmico deve-se referir: nome do evento, instituições organizadoras, lugar e data de realização.</li></ul><p> </p><ul><li>O livro objeto da resenha deve ter sido publicado nos dois últimos anos e constituir uma clara contribuição à investigação em comunicação. Se se trata da resenha de um evento acadêmico este deve ter sido realizado durante o último ano e ser um acontecimento de notável relevância internacional para os estudos em comunicação. Não necessariamente o livro ou evento resenhado tem que estar diretamente relacionado com o monográfico do número da revista ao qual se envia a resenha.</li></ul><p> </p><ul><li>Quem realize a resenha proposta à revista não deve ter participado como editor ou coautor do livro resenhado, ou ser parte do comité acadêmico do evento objeto do texto. É recomendável que o autor da resenha tenha uma trajetória acadêmica reconhecida em torno ao tema ou área específica no que se inscreve o livro ou evento referido.</li></ul><p> </p><ul><li>Espera-se que as resenhas de livros propostas à revista transcendam o plano meramente descritivo e ofereça, uma perspectiva crítica e construtiva, que permita identificar os alcances e limitações da obra, destacando a pertinência de seus aportes à área específica na qual se inscreve no campo dos estudos em comunicação.</li></ul><p> </p><ul><li>Para citações diretas do livro resenhado se fará referência entre parêntesis à página de onde toma-se a cita. Para citações de outras obras no corpo da resenha se utilizará as normas APA. </li></ul>',
    'en_US' => '<p><strong>Characteristics of the contributions and articles received</strong></p><p><em>Disertaciones</em> is a scientific and academic journal available through open access on the Internet.  It publishes original contributions pertinent to the field of Social Communication, particularly articles addressing i) Society and Information and Communication Technologies; ii) Communication and Politics; iii) Journalism; and iv) Communication and Culture.</p><p> </p><p>The journal accepts articles written in Spanish, English, or Portuguese. All articles submitted to <em>Disertaciones</em> should be previously unpublished; the journal will not accept works previously published in print media or on the Internet, nor works currently being evaluated by other publications.</p><p> </p><p>The contents of the journal are organized into four sections: <em>Estudios</em> (Studies)<em>, Avances</em> (Advances), <em>Ensayos </em>(Essays), and <em>Reseñas </em>(Reviews)<em>.</em></p><p> </p><p>The key endeavor of <em>Disertaciones</em> is to publish original and previously unpublished research articles, the results of which contribute to increasing scientific knowledge in the field of communication. These articles are published in the sections <em>Estudios</em> and <em>Avances</em>.</p><p> </p><p>The journal announces a thematic focus for each issue and issues a call for contributions within that area, and the <em>Estudios </em>section contains specialized articles on topics that contribute to the specific focus selected for each issue.</p><p> </p><p>The <em>Avances </em>section is open to articles on any research topic within the field of communication that contribute to increasing knowledge within the general thematic orientation of the journal.</p><p> </p><p>The<em> Ensayos</em> section publishes articles in which authors reflect on research experiences or provide a solid critical review of current academic literature pertinent to the thematic focus of each issue of the journal, making an original contribution to the theoretical or methodological debate in that area.</p><p> </p><p>The journal also publishes critical reviews of books and recent academic events relevant to communication studies. These texts appear in the <em>Reseñas </em>section.</p><p> </p><ul><li>Before being forwarded to peer evaluators, articles received by <em>Disertaciones</em> will be subject to an initial assessment by representatives of the journal’s editorial board in order to confirm that they conform to these guidelines for authors. As part of this process, the journal will use a software program that evaluates the level of originality of the text and the proper handling of citations and references.</li></ul><p> </p><p><strong><br /></strong></p><p><strong>Guidelines for the Structure and Formatting of Articles (<em>Estudios</em>, <em>Avances</em>, and <em>Ensayos</em> sections)</strong></p><p><strong> </strong><em> </em></p><ul><li>Manuscripts should be submitted in a Word file (.doc o .docx), written in 12-point Times New Roman font, with 1.5-line spacing on letter size pages with 1 inch margins and page numbers at the top right corner. Footnotes should be used exclusively to make clarifications and commentaries pertinent to the central text. They should be numbered consecutively and written in 10-point Times New Roman font. Bibliographic references should be at the end of the article. They should be ordered alphabetically and conform to the style guidelines of the American Psychological Association (APA), as described in its most recent edition (6th edition in English and 3rd edition in Spanish translated from the 6th edition in English).</li></ul><p> </p><ul><li>Articles published in the <em>Estudios</em>, <em>Avances</em>, and <em>Ensayos</em> sections should be between 4,000 and 9,000 words in length, including the abstract, footnotes, and bibliographical references.</li></ul><p> </p><ul><li>Manuscripts should not include any data or references that may identify their authors. Instead, a separate Word file should be submitted identifying each of the authors with their first name or names, family name or names, education, institutional affiliation, primary lines of research, and email address. This second file should also provide background information on the manuscript submitted, such as the research project on which it is based and recognition of the institutions that supported the project.</li></ul><p> </p><ul><li>Every article should be preceded by a concise title describing the subject and scope of the text and an abstract that summarizes the essential elements of the work in a single paragraph of no more than 200 words. This abstract should describe the article’s central arguments and its most relevant results, contributions, and conclusions. Both the title and the abstract should be in the same language as the article and also be translated into English (or into Spanish if the article is written in English).</li></ul><p> </p><ul><li>After the abstract, between three and five keywords should be provided that will allow readers to identify the contents of the article. The keywords should be in the original language of the article and also translated into English, or into Spanish if the article is written in English.</li></ul><p> </p><ul><li>Research articles published in the sections <em>Estudios</em> and <em>Avances</em> should be organized to generally follow the conventional structure of scientific works, particularly those in the social sciences. This means that they should have introductions, describe previous work or the state of work on the question at hand, methodology, and results. They should also include discussion and conclusions. It is expected that the specific structure of an article will be appropriate and consistent with the theoretical-methodological perspective of the study it describes.</li></ul><p> </p><ul><li>All articles should have titled or subtitled sections in keeping with the structure of the text. The introduction, however, should not be preceded by a title designating it as such, since it is assumed that the first part of the manuscript is the introduction. The other sections and subsections of the article will use different levels of titles and subtitles without letters or numbers, depending on the hierarchical structure of the information provided. Although most research articles are structured with up to three levels of titles and subtitles, <em>Disertaciones</em> uses a variation of APA style with the formatting of headings and subheadings indicating up to fivquotee levels of subordination:</li></ul><p>Table 1: Format for the hierarchical organization of titles and subtitles</p><table border="0" cellspacing="0" cellpadding="0"><tbody><tr><td valign="top" width="110"><p align="center"><strong>Title level</strong></p></td><td valign="top" width="431"><p><strong>Format</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">1</p></td><td valign="top" width="431"><p align="center"><strong>Section title, in bold and centered</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">2</p></td><td valign="top" width="431"><p><strong>Subtitle in bold, aligned left</strong></p></td></tr><tr><td valign="top" width="110"><p align="center">3</p></td><td valign="top" width="431"><p>    <strong>Paragraph subtitle, indented in bold </strong></p></td></tr><tr><td valign="top" width="110"><p align="center">4</p></td><td valign="top" width="431"><p>       <strong><em>Paragraph subtitle, indented in bold and italics </em></strong></p></td></tr><tr><td valign="top" width="110"><p align="center">5</p></td><td valign="top" width="431"><p>          <em>Paragraph subtitle, indented in italics</em></p></td></tr></tbody></table><p>Adapted from the Publication Manual of the APA, 3rd edition in Spanish translated from the 6th edition in English.</p><p> </p><p>Only the necessary title levels should be used, in keeping with the sections and subsections of the text. The manuscript may be structured with section titles only, in which case only a section title (title level 1) will be used, or it may have up to five levels of subsections, using the respective format specified for each title level.</p><p> </p><ul><li>If the article has figures and tables, they should be numbered using Arabic numbers corresponding to the sequence in which they are mentioned in the text. Tables should be sent in the same Word file as the manuscript and incorporated into the text using Word table formatting. Figures and photographs should likewise be incorporated into the Word file, but should also be sent as separate attachments in the JPG format. Every table incorporated into the article should have a descriptive name above it, and the captions of all figures should adequately explain their contents. Clarifying notes should appear under the table, along with a statement crediting the source of the data it contains. In order to present the data to readers in the clearest format possible, the use of vertical lines in tables should be avoided. For more detailed recommendations on the formatting of tables and figures, see Chapter 5 of the APA Publication Manual.</li></ul><p> </p><ul><li>The use of complementary online files is recommended for the detailed presentation of a data set and quantitative or qualitative research results. If the author requires the use of special displays such as interactive graphs, videos, or tables, the journal will take the steps necessary to incorporate these formats.</li></ul><p> </p><ul><li>The journal suggests to authors that they send the raw data set resulting from their research, along with the codebook used, in order to improve the rigor and communicability of the research report, along with the possibility of its replication or crosschecking of results by other researchers. This step is optional.</li></ul><p> </p><ul><li>Manuscripts submitted to <em>Disertaciones</em> are received through an online system for receiving texts for evaluation. It is available at: <a href="/index.php/disertaciones/">http://revistas.urosario.edu.co/index.php/<em>Disertaciones</em>/</a></li></ul><p> </p><p> </p><p><strong>Guidelines on style and bibliographical references</strong></p><p>Manuscripts for submission to the journal should be prepared in conformity with the standards for style, citations, and bibliographical references established in the APA publication manual (as detailed in the 6th edition in English and the 3rd edition in Spanish, which is the official translation of the 6th edition in English).</p><p> </p><p>Below we present a general outline of the guidelines for style and citations most commonly used in research articles:</p><p> </p><ul><li>Abbreviations referring to concepts and technical terms should be used only when strictly necessary. Abbreviations, initialisms, and acronyms should be preceded by their complete form the first time they appear, followed by the abbreviation, initialism, or acronym in parentheses. </li></ul><p> </p><ul><li>In reporting statistical data, mathematical formulas should be used only when they are essential or when they present a new mathematical or statistical expression, not for the presentation of commonly used statistical data. It is preferable for equations to be presented in a format that is editable by a word processing program rather than an image format. For specific details regarding the presentation of statistical and mathematical materials, see Chapter 4 of the APA publication manual. </li></ul><p> </p><ul><li>Following APA guidelines, direct quotes and paraphrases should be attributed to their sources within the text, specifying the author, year of publication, and page of the source material. Direct quotes of under 40 words should be incorporated directly into the text between quotation marks, with the source provided between parentheses after the close quote. Direct quotes of more than 40 words should be presented in a separate paragraph without quotation marks, indented from the left margin by 1 inch,. The source of the quote should be cited between parentheses after the final punctuation mark of the quote.</li></ul><p> </p><ul><li>A list of references should be presented in alphabetical order at the end of the article under the heading References, including only those references that have in fact been used and cited in the body of the text. The list of references and all citations should be formatted in keeping with APA guidelines in the English 6th edition or the official translation to Spanish (3rd edition), depending on the language in which the article is written.</li></ul><p> </p><ul><li>For specific questions about citing sources, authors are recommended to consult (<a href="http://www.apastyle.org/">www.apastyle.org</a>), the English-language website on APA style guidelines, in addition to the style manuals mentioned above.</li></ul><p> </p><p><strong>General guidelines for the presentation of book reviews and reviews of academic events </strong></p><p><strong> </strong></p><ul><li>The maximum length for a review is 1,500 words. Reviews should be submitted as Word files formatted with the font, spacing, and margins as described in the requirements for the submission of journal articles. The author should be identified in the same Word file, providing his or her full name, institutional affiliation, and lines of research. <strong></strong></li></ul><p><strong> </strong></p><ul><li>In the case of a book review, full bibliographic information on the book being reviewed should be provided at the end of the text, including the complete title of the book, the author’s name, the year of publication, city, publisher, and number of pages. In a review of an academic event, references should include the name of the event, the institutions that organized it, and the date and place where it took place.<strong></strong></li></ul><p><strong> </strong></p><ul><li>A book being reviewed should have been published in the last two years and should constitute a clear contribution to research in communication. In the case of a review of an academic event, the event should have been held over the course of the previous year and should have been of notable importance to communication studies at the international level. The book or event being reviewed need not be directly related to the thematic focus of the journal issue for which the review is submitted. <strong></strong></li></ul><p><strong> </strong></p><ul><li>The person submitting a review to the journal should not have participated as editor or coeditor of the book being reviewed and should not have been a member of the academic committee that organized the event being reviewed. It is recommended that the review’s author have a recognized academic record on the topic or in the same specific area as the book or academic event being reviewed. <strong></strong></li></ul><p><strong> </strong></p><ul><li>It is expected that reviews submitted to the journal do more than merely describe the book or event being reviewed. They should offer constructive criticism that allows readers to identify the achievements and limitations of the work with an emphasis on its contributions to the specific area of communication studies that it addresses.<strong></strong></li></ul><p><strong> </strong></p><ul><li>Direct quotes from the book being reviewed should be followed by parentheses containing the page number from which the quotation was taken. APA guidelines should be followed when other works are cited within the body of the review. <strong></strong></li></ul>',
  ),
  'description' => 
  array (
