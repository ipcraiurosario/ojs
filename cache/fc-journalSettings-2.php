<?php return array (
  ...
  'boardEnabled' => true,
  'categories' => NULL,
  'contactEmail' => 'jochen.kleinschmidt@urosario.edu.co',
  'contactFax' => '',
  'contactName' => 'Dr. Jochen Kleinschmidt',
  'contactPhone' => '',
  'copyrightHolderType' => 'journal',
  'copyrightNoticeAgree' => true,
  'copyrightYearBasis' => '',
  'copySubmissionAckAddress' => 'sarah.nieto@urosario.edu.co',
  'copySubmissionAckPrimaryContact' => true,
  'copySubmissionAckSpecified' => true,
  'defaultMetricType' => '',
  'disableUserReg' => false,
  'displayCurrentIssue' => true,
  'emailSignature' => 'Revista Desafìos
Facultad de Ciencia Política, Gobierno y Relaciones Internacionales
Universidad del Rosario
Carrera 6A 12C-13, Edificio Santafé, oficina 206
Bogotá D. C., Colombia
Teléfono: (57 1) 2970200, extensión 3783
Celular: 57+ 316 4611516
revistadesafios@urosario.edu.co
_____________________________________________

Desafíos
http://revistas.urosario.edu.co/index.php/desafios',
  ...
  array (
    ...
    'dateUploaded' => '2011-09-01 11:11:39',
  ),
  'journalTheme' => 'mpg',
  'licenseURL' => 'http://creativecommons.org/licenses/by-nc/4.0',
  'mailingAddress' => '<p>Facultad de Ciencia Política, Gobierno y Relaciones Internacionales<br />Universidad del Rosario<br />Carrera 6A 12C-13, edificio Santafé, oficina 206<br />Bogotá D. C., Colombia<br />Teléfono: (571) 2970200, extensión: 3783</p>',
...
<p>&nbsp;</p>
  ...
  array (
    'en_US' => '<div><strong>Call for papers Feminist Perspectives on Global Governance</strong></div><div><p>Assessing global challenges requires thinking about new strategies and mechanisms for international cooperation. This endeavor implies reflecting on domestic sources of global governance such as the role of non-state actors with sufficient will and power to influence global problem-solving processes, involving climate change, poverty, global terrorism, inequality, organized crime, economic crisis, gender violence and urban violence, among other global threats. A focus on women´s leadership and contributions to global problem-solving is thus warranted in order to identify women´s empowerment and influence on global governance.  The general question this special edition seeks to answer is: what difference does it make to have more women in leadership positions in global governance?</p><ul><li>Women´s leadership in NGOs and International Organizations;</li><li>Women diplomats;</li><li>The role of women in epistemic communities;</li><li>Women in academia;</li><li>The role of high-ranking women in multinational corporations;</li><li>Women´s social movements;</li><li>Leadership and women´s empowerment; and</li><li>Political activism.</li></ul><p> </p><p> </p></div>',
    'es_ES' => '<blockquote><p> </p></blockquote>',
  ),
  'authorGuidelines' => 
  array (
    'en_US' => '<p><span>RULES FOR PUBLICATION OF ARTICLES ON THE JOURNAL DESAFÍOS</span></p><p>The Editorial Board of the Journal Desafíos published by the Center for Political and International Studies (CEPI acronym in Spanish for “Centro de Estudios Políticos e Internacionales”) of the Departments of Political Science, Government, and International Relations of Universidad del Rosario (Bogota, Colombia) accepts proposals for academic articles which shall be evaluated by an external reviewing process (by two reviewing peers) with following formal requirements.</p><p>Categories that apply to the journal:</p><p>a. <span>Article of scientific and technological research.</span> Article that presents in detail the original results of the research projects. The generally applied structure contains four important sections: introduction, methodologies, results and conclusions.</p><p>b. <span>Think-piece</span>. Document that presents research results from an analytical, interpretative or critical perspective of the author on a specific topic and using original sources.</p><p>c. <span>Review article</span>. Article resulting from an investigation that analyzes, systematizes and integrates published or unpublished research results on a field of science or technology aiming at the creation of awareness for progress and development trends. A careful bibliographic review of at least 50 references characterizes this document.</p><p>d<span>. Concept paper</span>. Short article in a particular domain of knowledge that may or may not present research results and usually includes a limited number of references.</p><p>d. <span>Book review</span>. Document that assesses and analyzes emerging publications in the field of knowledge of the journal (political science, international relations, political philosophy, political sociology, political economy), whether journals or books. (These are not taken into account when indexing).</p><p>N.B.: The main purpose of the book review is not the mere provision of a summary but a critical analysis of the content. Meaning that the author of the book review is to assess the contribution to scientific knowledge in a field or specific topic of Social Sciences. Locating the book in this context and critically analyzing the contribution and its value for the progress in the specific field is a key element of a book review published in Desafíos. (These are not taken into account when indexing).</p><p><span>Formal requirements:</span></p><p>• Articles shall be submitted unpublished and originally be written in Spanish, English or French, with a word count ranging between 8,000 and 12,000, in Word format, Times New Roman font, size 12, and 1.5 space.</p><p>• Articles shall be submitted with a summary of no more than 200 words and three to five assigned keywords. The submissions shall also contain a corresponding abstract and keywords in English. (If the article is presented in English or Portuguese, abstract and keywords shall additionally be provided in Spanish).</p><p>• All graphs or tables shall be accompanied by a title or a brief description regarding the content and mention the complete source (if the source originates from the Internet, the uniform resource locator (URL) shall also be included). All illustrations, figures and tables shall be located within the text in the adequate position and not at the end of the document.</p><p>• Articles shall mention institutional affiliation of the author, authors or co-authors in accordance in the first sheet, in a footnote, according the following scheme: author\'s name, title, institution, agency, institution, department, city, country, email. It is important to mention the person who has made a substantial contribution to the document in the footnote; it is inappropriate to recognize as authors directors of institutions and department heads who only marginally participated in the elaboration of the document.</p><p>• A short resume of the author (authors and / or co-authors) shall be provided along with the article. The resume shall outline obtained degrees (doctorates, masters and undergraduate) from different universities, relevant work experience, academic experience, and reference the work published in indexed academic journals from the last two years.</p><p>• The book reviews shall refer to books and journals published not earlier than two years prior to the submission. Book reviews shall be written in either Spanish or English and not extend a maximum length of 2,000 words.</p><p>• All bibliographical references shall be in-text citations, appear in the parentheses  inside the text area and be abbreviated according to the standards of the American Psychological Association (APA):</p><p><span>Book:</span></p><p>Arendt, H. (1951). The Origins of Totalitarianism. New York: Harcourt Brace.</p><p><span>Book chapter:</span></p><p>Parker, C. G. (2012). Religión, cultura y política en América Latina: nuevos enfoques. In C. G. Parker (Ed.), <em>Religión, política y cultura en América Latina: nuevas miradas</em> (pp. 13-73). Santiago de Chile: Universidad de Santiago de Chile</p><p><span>Journal article:</span></p><p>Launay, S. (2012). Démocratie représentative et démocratie participative. Remarques pour une comparaison de la Colombie et du Venezuela contemporains. <em>Desafíos</em>, 24(1), 155-173.</p><p><span>Electronic source:</span></p><p>Uribe Escobar, J. D. (2006). Evolución de la educación en Colombia durante el siglo xx. Retrieved on February 4, 2014 from <a href="http://www.banrep.gov.co/documentos/publicaciones/revista_bco_%20notas/2006/febrero.pdf">http://www.banrep.gov.co/documentos/publicaciones/revista_bco_ notas/2006/febrero.pdf</a>.</p><p>All accepted article shall be subject to the scrutiny of the Editorial Board, to the peer-review and to formal modifications required to adapt the text to the publishing norms.</p><p>For any further concerns please contact: revistadesafios.urosario@gmail.com</p><div> </div>',
    'es_ES' => '<p><strong>NORMAS PARA LA PUBLICACIÓN DE ARTÍCULOS EN LA REVISTA DESAFÍOS</strong></p><p>La revista<em> Desafíos</em> recibe manuscritos que presenten resultados de investigación, reseñas y documentos de reflexión <strong><span style="text-decoration: underline;">inéditos y originales</span></strong> en las áreas de la Ciencia Política y las Relaciones Internacionales de acuerdo con las categorias y los requisitos formales que a continuación se describen.</p><p>Categorías de la revista:</p><p>a. <span style="text-decoration: underline;">Artículo de investigación científica y tecnológica</span>. Documento que presenta de manera detallada los resultados originales de proyectos de investigación. La estructura generalmente utilizada contiene cuatro apartes importantes: introducción, metodología, resultados y conclusiones.</p><p>b. <span style="text-decoration: underline;">Artículo de reflexión</span>. Documento que presenta resultados de investigación desde una perspectiva analítica, interpretativa o crítica del autor, sobre un tema específico y recurriendo a fuentes originales.</p><p>c. <span style="text-decoration: underline;">Artículo de revisión</span>. Documento resultado de una investigación donde se analizan sistematizan e integran los resultados de investigaciones publicadas o no publicadas, sobre un campo en ciencia o tecnología con el fin de dar cuenta de los avances y las tendencias de desarrollo. Se caracteriza por presentar una cuidadosa revisión bibliográfica de por lo menos 50 referencias.</p><p>d. <span style="text-decoration: underline;">Documentos de reflexión</span>. Artículos cortos en un dominio particular del conocimiento, que pueden o no presentar resultados de investigaciones y usualmente presentan un número reducido de referencias bibliográficas.</p><p>e. <span style="text-decoration: underline;">Reseñas</span>. Documento que valora y analiza las publicaciones de reciente aparición en el campo del conocimiento de la revista (Ciencia Política, Relaciones Internacionales, Filosofía Política, Sociología Política, Economía Política). El propósito principal de una reseña no es ofrecer un resumen del libro sino un análisis crítico. En ella se debe evaluar la contribución del libro al conocimiento científico en un campo o un tema específico de las Ciencias Sociales; ubicar el libro en este contexto y analizar críticamente su contribución al avance en el campo específico es un elemento fundamental de una reseña publicada en <em>Desafíos</em>.</p><p><strong><br /></strong></p><p><strong>Requisitos formales</strong></p><p>• Los manuscritos deben ser inéditos y originales escritos en español, inglés o portugués, con una extensión que oscile entre 8 000 y 10 000 palabras, formato Word, fuente Times New Roman, tamaño 12, a espacio 1,5.</p><p>• Los manuscritos deben incluir un resumen —no más de 150 palabras— y las palabras clave. Es necesario, igualmente, incorporar el respectivo resumen, título y palabras clave en inglés; si el manuscrito es presentado en inglés, en español. Nota: <em>Desafíos</em> solo recibirá manuscritos en inglés de autores anglohablantes.</p><p>• Los gráficos, fotografías y diagramas se nombrarán <span style="text-decoration: underline;">figuras</span>; la información presentada en tablas y cuadros, <span style="text-decoration: underline;">tablas</span>. Cada figura o tabla utilizada se debe acompañar de un título breve referente al contenido, enumerarse consecutivamente, ser nombrada en el cuerpo del texto y citar su fuente completa (si la fuente proviene de internet, incluir la dirección electrónica de la página).</p><p>• Junto con el manuscrito, en un archivo independiente, se debe presentar la información relacionada con los/las autores/as o co-autores/as de acuerdo con el siguiente modelo: nombres y apellidos, cargo actual, institución, dependencia, departamento, ciudad, país, correo electrónico y ORCID iD (https://orcid.org). La información, además, debe incluir una breve reseña de los/as autores/as donde se detalle: títulos (doctorados, maestrías y pregrados) e instituciones en donde se obtuvieron, experiencia laboral relevante, experiencia académica y artículos publicados en revistas académicas indexadas en los últimos dos años. Es importante resaltar que debe aparecer registrada la persona que ha hecho la contribución sustancial al documento; es inadecuado reconocer como autor/a a los/las directores/as de instituciones y departamentos que hayan participado marginalmente en su elaboración.</p><p>• En los comentarios para el editor, el/la autor/a puede sugerir el nombre de al menos cinco posibles evaluadores de su manuscrito. </p><p>• Las reseñas deberán ser de libros publicados durante los dos años anteriores a la entrega de las mismas en español o inglés y con una extensión de máximo 2 000 palabras.</p><p>• Las referencias bibliográficas a lo largo del manuscrito deben citarse dentro del texto, entre paréntesis y de manera abreviada, de acuerdo con las normas de la American Psychological Association (APA). Todas las referencias de la lista final serán aquellas mencionadas en el cuerpo del texto (incluyendo las referencias de las notas de pie de página); asimismo, todas las referencias mencionadas en el texto deberán incluirse en la lista final. Se recomienda a los/las autores/as el uso de los gestores bibliográficos, para, así, facilitar el proceso de edición. Se deberá incluir el DOI (<em>Digital Object Identifier</em>) de todas las referencias que cuenten con este. A continuación algunos ejemplos: </p><p> </p><p><strong>Libro:</strong></p><p>Arendt, H. (1951). <em>The Origins of Totalitarianism.</em> New York: Harcourt Brace.</p><p> </p><p><strong>Capítulo de libro:</strong></p><p>Parker, C. G. (2012). Religión, cultura y política en América Latina: nuevos enfoques. En C. G. Parker (Ed.), <em>Religión, política y cultura en América Latina: nuevas miradas </em>(pp. 13-73). Santiago de Chile: Universidad de Santiago de Chile.</p><p><strong> </strong></p><p><strong>Artículo de revista:</strong></p><p>Mouly, C. &amp; Garrido, M.B. (2018). No a la guerra: resistencia civil en dos comunidades periféricas de Colombia. <em>Desafíos, 30</em>(1), 245-277. Doi: http://dx.doi.org/10.12804/revistas.urosario.edu.co/ desafios/a.5282</p><p><strong> </strong></p><p><strong>Fuente electrónica:</strong></p><p>Uribe Escobar, J. D. (2006). <em>Evolución de la educación en Colombia durante el siglo XX</em>. Recuperado de http://www.banrep.gov.co/documentos/publicaciones/revista_bco_notas/2006/febrero.pdf.</p><p>Cada  manuscrito aceptado quedará supeditado a la revisión por parte del Comité Editorial, a la evaluación de los pares y a las modificaciones formales que se requieran para adaptar el texto a las normas de publicación. Cualquier inquietud adicional por favor diríjase a: <a href="mailto:revistadesafios.urosario@gmail.com">revistadesafios.urosario@gmail.com</a></p><p> </p>',
  ),
  'contactMailingAddress' => 
  array (
    'en_US' => '<html />',
    'es_ES' => '<p>Facultad de Ciencia Política, Gobierno y Relaciones Internacionales<br />Universidad del Rosario<br />Carrera 6A 12C-13, edificio Santafé, oficina 212<br />Bogotá D. C., Colombia<br />Teléfono: (571) 2970200, extensión: 3730</p>',
    'pt_BR' => '<html />',
  ),
  'description' => 
  array (
...
<p>Dr. Zidane Zeraoui</p>
  ...
  array (
    'en_US' => '<html />',
    'es_ES' => '<span style="font-size: small;"><span style="font-size: 11px; line-height: 15px;">La revista <em>Desafíos</em> es una publicación académica semestral de la Facultad de Ciencia Política, Gobierno y Relaciones Internacionales de la Universidad del Rosario.</span></span>',
    'pt_BR' => '<html />',
  ),
  'reviewGuidelines' => 
  array (
    'en_US' => '<p>This journal provides free and immediate access to its contents under the principle that making research available to the public without cost promotes the sharing of knowledge around the world. For the same reason, <span>the journal imposes no costs</span> on authors for the processing and publication of their articles.</p><p>Committed to the dissemination of scientific knowledge to non-specialized audiences, <em>Desafios</em> also promotes its contents through <a href="http://www.lasillavacia.com/iq" target="_blank">www.lasillavacia.com/iq</a> </p>',
    'es_ES' => '<p>La evaluación de cada uno de los artículos se hará a partir de la revisión exhaustiva de aspectos específicos como: organización, redacción, manejo del tema, conclusión, relevancia e innovación, y, revisión bibliográfica.</p>',
  ),
  'abbreviation' => 
  array (
    'es_ES' => 'DESAFÍOS',
  ...
  'authorInformation' => 
  array (
    'es_ES' => '¿Tiene interés en hacer un envío a esta revista? Le recomendamos que revise la sección <a href="/index.php/desafios/about">Acerca de la revista</a><a> para consultar la política de la misma, así como las </a><a href="/index.php/desafios/about/submissions#authorGuidelines">Normas de autores/as</a>. Los/as autores/as necesitan <a href="/index.php/desafios/user/register">registrarse</a> en la revista para poder hacer envíos, o si ya están registrados pueden simplemente <a href="/index.php/index/login">identificarse</a> y empezar el proceso de 5 pasos.',
  ),
  ...
  array (
    ...
    array (
      ...
      'width' => 329,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phprtwwZj\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:12:27',
    ),
  ),
  'journalPageFooter' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'width' => 329,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpst1JQg\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:12:35',
    ),
  ),
  'privacyStatement' => 
  array (
    'es_ES' => '<p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;">Los nombres y direcciones de correo-e introducidos en esta revista serán exclusivamente para los fines declarados por esta revista, es decir:</span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;"><br /></span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;">a)   Para enviarle una notificación cuando aparezca un nuevo número de la revista.</span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;"><br /></span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;">b)   Para recibir de usted una contribución para que sea considerada para publicación por <em>Desafíos</em>.</span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;"><br /></span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;">c)   Para solicitarle que haga revisiones ciegas de contribuciones a la revista.</span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;"><br /></span></p><p class="instruccionesautores" style="margin: auto 0cm;"><span style="color: #000000; font-size: 7.5pt;">Por tanto, los nombres y direcciones de correo-e introducidos en esta revista no estarán disponibles para ningún otro propósito u otra persona.</span></p>',
  ),
  'proofInstructions' => 
  array (
  ...
  'readerInformation' => 
  array (
    'es_ES' => 'Recomendamos a los/as lectores/as que se den de alta en el servicio de notificación de publicación de esta revista. Use el enlace de <a href="/index.php/desafios/user/register">Registro</a> que se encuentra arriba en la home de la revista. Este registro permitirá al / a la lector/a recibir la Tabla de contenidos por correo-e cada vez que se publique un nuevo número de la revista. Esto también permitirá a la revista conseguir un cierto nivel de soporte y número de lectores/as. Consulte la <a href="/index.php/desafios/about/submissions#privacyStatement">Política de Privacidad</a> de la revista, que asegura a los/as lectores/as que su nombre y dirección de correo-e no serán usados para otros propósitos.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  'searchDescription' => 
  array (
    'es_ES' => 'Revista científica en Ciencia Política y Relaciones Internacionales',
  ),
  'searchKeywords' => 
  array (
    'es_ES' => 'Ciencia Política; Relaciones Internacionales',
  ),
  'submissionChecklist' => 
  array (
    'es_ES' => 
    array (
      ...
      array (
        'order' => '4',
        'content' => 'El texto tiene interlineado 1.5; el tamaño de fuente es 12 puntos; se usa cursiva en vez de subrayado (exceptuando las direcciones URL); y todas las ilustraciones, figuras y tablas están dentro del texto en el sitio que les corresponde y no al final del todo.',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'El texto cumple con los requisitos bibliográficos y de estilo indicados en las <a href="/index.php/desafios/about/submissions#authorGuidelines">Normas para autoras/es</a>, que se pueden encontrar en Acerca de la revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'Si esta enviando a una sección de la revista que se revisa por pares, tiene que asegurase que las instrucciones en <a href="javascript:openHelp(\'http://revistas.urosario.edu.co/index.php/desafios/help/view/editorial/topic/000044\')">Asegurando de una revisión a ciegas</a>) han sido seguidas.',
      ),
    ),
  ),
