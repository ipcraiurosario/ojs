...
">
	<?php if ($this->_tpl_vars['FBV_label']): ?>
		<?php if ($this->_tpl_vars['FBV_translate']): ?><?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => ((is_array($_tmp=$this->_tpl_vars['FBV_label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'FBV_labelTranslated') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'FBV_labelTranslated'));?>

		<?php else: ?><?php $this->assign('FBV_labelTranslated', $this->_tpl_vars['FBV_Label']); ?><?php endif; ?>
		<?php if ($this->_tpl_vars['FBV_labelFor']): ?><label for="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_labelFor'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"><?php echo $this->_tpl_vars['FBV_labelTranslated']; ?>
<?php if ($this->_tpl_vars['FBV_required']): ?><span class="req">*</span><?php endif; ?></label>
...
?>
				<span class="error"><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_error'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
