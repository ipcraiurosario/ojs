...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'frontend/pages/submissions.tpl', 22, false),array('function', 'url', 'frontend/pages/submissions.tpl', 28, false),array('modifier', 'nl2br', 'frontend/pages/submissions.tpl', 57, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
				...
				<?php echo $this->_tpl_vars['currentJournal']->getLocalizedSetting('authorGuidelines'); ?>
...
unset($_smarty_tpl_vars);
 ?>
				...
				<?php echo $this->_tpl_vars['currentJournal']->getLocalizedSetting('copyrightNotice'); ?>
