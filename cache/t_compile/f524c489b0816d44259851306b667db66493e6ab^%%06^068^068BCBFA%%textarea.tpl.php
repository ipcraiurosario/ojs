...
<?php endif; ?><?php if ($this->_tpl_vars['FBV_rich'] && ! $this->_tpl_vars['FBV_disabled']): ?> richContent<?php if ($this->_tpl_vars['FBV_rich'] === 'extended'): ?> extendedRichContent<?php endif; ?><?php endif; ?>"
			...
			<?php if ($this->_tpl_vars['FBV_wordCount']): ?> wordCount="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_wordCount'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"<?php endif; ?>
