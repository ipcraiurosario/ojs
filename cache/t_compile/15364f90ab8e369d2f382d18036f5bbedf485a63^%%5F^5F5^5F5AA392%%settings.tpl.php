...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.plugins"), $this);?>
        ...
        <li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "tab.settings.AdminSettingsTabHandler",'op' => 'showTab','tab' => 'navigationMenus'), $this);?>
