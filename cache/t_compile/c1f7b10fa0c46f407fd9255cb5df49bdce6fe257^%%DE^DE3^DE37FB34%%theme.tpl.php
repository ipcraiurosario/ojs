<?php /* Smarty version 2.6.25-dev, created on 2019-06-14 11:56:48
         compiled from controllers/tab/settings/appearance/form/theme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'fbvFormArea', 'controllers/tab/settings/appearance/form/theme.tpl', 18, false),array('block', 'fbvFormSection', 'controllers/tab/settings/appearance/form/theme.tpl', 24, false),array('function', 'fbvElement', 'controllers/tab/settings/appearance/form/theme.tpl', 25, false),array('modifier', 'concat', 'controllers/tab/settings/appearance/form/theme.tpl', 34, false),array('modifier', 'escape', 'controllers/tab/settings/appearance/form/theme.tpl', 34, false),array('modifier', 'compare', 'controllers/tab/settings/appearance/form/theme.tpl', 40, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'selectTheme')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php if ($this->_tpl_vars['wizardMode']): ?>		<?php $this->assign('themeDescription', ""); ?>
	<?php else: ?>
		<?php $this->assign('themeDescription', "manager.setup.layout.themeDescription"); ?>
	<?php endif; ?>
	<?php $this->_tag_stack[] = array('fbvFormSection', array('label' => "manager.setup.layout.theme",'for' => 'themePluginPath','description' => $this->_tpl_vars['themeDescription'])); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
