<?php /* Smarty version 2.6.25-dev, created on 2019-06-14 11:56:48
...
" class="localization_popover_container">
		<input type="<?php if ($this->_tpl_vars['FBV_isPassword']): ?>password<?php elseif ($this->_tpl_vars['FBV_isTypeURL']): ?>url<?php else: ?>text<?php endif; ?>"
			<?php echo $this->_tpl_vars['FBV_textInputParams']; ?>

			class="localizable <?php if ($this->_tpl_vars['FBV_class']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_class'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?><?php if ($this->_tpl_vars['FBV_validation']): ?> <?php echo $this->_tpl_vars['FBV_validation']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['formLocale'] != $this->_tpl_vars['currentLocale']): ?> locale_<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?>"
			...
			value="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_value'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"
...
[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]"
...
?><?php if ($this->_tpl_vars['formLocale'] != $this->_tpl_vars['thisFormLocale']): ?>
				<input	type="<?php if ($this->_tpl_vars['FBV_isPassword']): ?>password<?php else: ?>text<?php endif; ?>"
					...
					placeholder="<?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocaleName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"
					class="multilingual_extra flag flag_<?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php if ($this->_tpl_vars['FBV_sizeInfo']): ?> <?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_sizeInfo'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php endif; ?>"
					<?php if ($this->_tpl_vars['FBV_disabled']): ?> disabled="disabled"<?php endif; ?>
					<?php if ($this->_tpl_vars['FBV_readonly']): ?> readonly="readonly"<?php endif; ?>
					value="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_value'][$this->_tpl_vars['thisFormLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"
					name="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
"<?php endif; ?>
		<?php if ($this->_tpl_vars['FBV_required']): ?> required aria-required="true"<?php endif; ?>
		<?php if ($this->_tpl_vars['FBV_urlValidationErrorMessage']): ?> data-msg-url="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_urlValidationErrorMessage'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"<?php endif; ?>
	/>
...
" type="hidden" 
		name="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"
		value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['FBV_value'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"
		id="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<?php echo $this->_tpl_vars['uniqId']; ?>
-altField" />
