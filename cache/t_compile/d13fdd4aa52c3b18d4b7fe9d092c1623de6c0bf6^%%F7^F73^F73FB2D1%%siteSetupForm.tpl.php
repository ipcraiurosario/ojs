...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 17, false),array('function', 'csrf', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 24, false),array('function', 'fbvElement', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 28, false),array('function', 'translate', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 89, false),array('function', 'fieldLabel', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 92, false),array('function', 'fbvFormButtons', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 108, false),array('modifier', 'json_encode', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 17, false),array('modifier', 'escape', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 96, false),array('block', 'fbvFormSection', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 27, false),array('block', 'fbvFormArea', 'controllers/tab/settings/siteSetup/form/siteSetupForm.tpl', 40, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'sitePrivacyStatement','title' => "manager.setup.privacyStatement")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array('description' => "manager.setup.privacyStatement.description")); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'textarea','multilingual' => true,'name' => 'privacyStatement','id' => 'privacyStatement','value' => $this->_tpl_vars['privacyStatement'],'rich' => true), $this);?>
