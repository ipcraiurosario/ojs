<?php /* Smarty version 2.6.25-dev, created on 2019-06-17 08:01:55
         compiled from frontend/components/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'frontend/components/header.tpl', 22, false),array('modifier', 'escape', 'frontend/components/header.tpl', 25, false),array('modifier', 'default', 'frontend/components/header.tpl', 25, false),array('modifier', 'strip_tags', 'frontend/components/header.tpl', 81, false),array('function', 'translate', 'frontend/components/header.tpl', 23, false),array('function', 'load_menu', 'frontend/components/header.tpl', 47, false),array('function', 'url', 'frontend/components/header.tpl', 74, false),)), $this); ?>
...
">
						<a class="custom-home-image" href="<?php echo $this->_tpl_vars['baseUrl']; ?>
"><img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/templates/images/custom/homepage.png" alt=""></a>
						...
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "frontend/custom/top-menu-block.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					</nav>
...
" <?php if ($this->_tpl_vars['displayPageHeaderLogo']['altText'] != ''): ?>alt="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['pageTitleTranslated'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" class="navbar-brand">
								<img src="<?php echo $this->_tpl_vars['baseUrl']; ?>
/templates/images/structure/logo-ur.png" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['applicationName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" />
						...
						<?php endif; ?>
							<div class="navbarTitle">
								<div class="navbarAppTitle"><?php echo $this->_tpl_vars['portalTitle']; ?>
</div>
								<div class="navbarPageTitle">
									<?php if ($this->_tpl_vars['portalTitle'] != $this->_tpl_vars['siteTitle']): ?>
					...
					<?php endif; ?>
								...
								<?php ob_start(); ?>
				<div class="container">
					<?php echo $this->_plugins['function']['load_menu'][0][0]->smartyLoadNavigationMenuArea(array('name' => 'primary','id' => "journal-navigation",'ulClass' => "nav navbar-nav"), $this);?>

				</div>
				<br />
				<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('primaryMenu', ob_get_contents());ob_end_clean(); ?>

				<?php if (! empty ( trim ( $this->_tpl_vars['primaryMenu'] ) ) || ! $this->_tpl_vars['noContextsConfigured']): ?>
