...
" dir="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentLocaleLangDir'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, 'ltr') : smarty_modifier_default($_tmp, 'ltr')); ?>
">
...
/templates/images/structure/logo.png">
					...
					<ul id="navigationPrimary" class="pkp_navigation_primary pkp_nav_list" role="navigation" aria-label="<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.navigation.site"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp));?>
">

												<?php if (( count ( ( array ) $this->_tpl_vars['userRoles'] ) === 1 && in_array ( ROLE_ID_READER , ( array ) $this->_tpl_vars['userRoles'] ) )): ?>
							<li>
								<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'page' => 'submission','op' => 'wizard'), $this);?>
">
...
">
						...
						<?php if (array_intersect ( array ( ROLE_ID_MANAGER ) , ( array ) $this->_tpl_vars['userRoles'] )): ?>
							<li aria-haspopup="true" aria-expanded="false">
								<a href="#"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.settings"), $this);?>
</a>
								<ul>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.distribution"), $this);?>
							...
							<li aria-haspopup="true" aria-expanded="false">
								<a href="#"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.access"), $this);?>
</a>
								<ul>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.siteAccessOptions.siteAccessOptions"), $this);?>
							...
							<li aria-haspopup="true" aria-expanded="false">
								<a href="#"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.tools"), $this);?>
</a>
								<ul>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.tools.statistics"), $this);?>
						...
						<?php if (array_intersect ( array ( ROLE_ID_SITE_ADMIN ) , ( array ) $this->_tpl_vars['userRoles'] )): ?>
							<?php if ($this->_tpl_vars['currentContext'] && ! array_intersect ( array ( ROLE_ID_MANAGER ) , ( array ) $this->_tpl_vars['userRoles'] )): ?>
							<li>
								<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'page' => 'management','op' => 'access','anchor' => 'users'), $this);?>
">
