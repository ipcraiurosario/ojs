<?php return array (
  ...
  'manager.setup.plnPluginEnable' => 'Módulo PKP PN activado',
  'manager.setup.plnDescription' => 'La Red de Preservación de PKP (PKP Preservation Network, en inglés) proporciona servicios gratuitos de preservación para cualquier revista OJS que cumpla con los criterios básicos.',
  'manager.setup.plnSettingsDescription' => 'Haga clic en el enlace de ajustes para aceptar los términos de uso de PKP PN.',
  'manager.setup.plnPluginArchiving' => 'PKP Preservation Network (PN)',
  'manager.setup.plnPluginNotInstalled' => 'PKP Preservation Network (PN) proporciona servicios gratuitos de preservación para cualquier revista OJS que cumpla con los criterios básicos. El módulo PKP PN para OJS 3 está actualmente en desarrollo y estará disponible el la garería de módulos pronto.',
  'manager.setup.otherLockss' => 'Opciones alternativas de archivo',
  ...
  'manager.setup.editorialTeam.description' => 'Listar editores/as, directores/as de gestión y otras personas asociadas con la revista.',
  ...
  'manager.setup.layout' => 'Estilo de la revista',
  ...
  'manager.setup.journalSummary' => 'Índice de la revista',
  'manager.setup.journalSummary.description' => 'Una breve descripción de su revista para mostrar en la lista de revistas.',
  'manager.setup.journalAbout' => 'Acerca de la revista',
  'manager.setup.journalAbout.description' => 'Incluya toda la información sobre su revista que considere de interés para lectores/as, autores/as o revisores/as, por ejemplo: la política de acceso abierto, el enfoque y ámbito de la revista, el aviso de derechos de autor, la declaración de esponsorización, la historia de la revista, la declaración de privacidad o la inclusión en algún sistema de archivo LOCKSS o CLOCKSS.',
  'manager.setup.favicon' => 'Icono de página de la revista',
  'manager.setup.faviconDescription' => 'Añada un icono de página de la revista para mostrarlo en un costado de la barra de navegación a los usuarios que visiten el sitio.',
  'manager.setup.faviconInvalid' => 'Formato de icono de página no valido. Los formatos aceptados son: .ico, .png y .gif.',
  ...
  'manager.setup.journalThumbnail.altText' => 'Texto alternativo para la miniatura',
  'manager.setup.enableArchive' => 'Permitir el archivado',
  ...
  'manager.setup.resetPermissions.confirm' => '¿Está seguro de que desea reiniciar los datos sobre permisos ya adjuntados a los artículos?',
  ...
  'subscriptionManager.subscription.confirmRemove' => '¿Está seguro de que desea eliminar la suscripción?',
  ...
  'manager.subscriptionPolicies.expiryReminderAfterMonths' => 'Notificar a los suscriptores por correo electrónico tras la caducidad de la suscripción.',
  ...
  'manager.subscriptions.confirmRenew' => '¿Está seguro de que desea renovar la suscripción?',
