<?php return array (
  ...
  'boardEnabled' => true,
  'categories' => NULL,
  'contactEmail' => 'anuariocdi@gmail.com',
  'contactFax' => '+57-1 2970296',
  'contactName' => 'Ricardo Abello Galvis',
  'contactPhone' => '+57-1 2970200 Ext 4313',
  'contributors' => 
  array (
  ),
  ...
  'mailingAddress' => '<p>Universidad del Rosario<br />Facultad de Jurisprudencia<br />Calle 14 No. 6-25<br />Bogotá - Colombia</p>',
  ...
  'publisherUrl' => 'http://www.anuariocdi.org',
  'publishingMode' => 0,
  ...
  array (
    0 => 
    array (
      'institution' => 'Asociación Cavelier del Derecho',
      'url' => 'http://www.cavelier.com',
    ),
  ),
  ...
  'supportEmail' => 'anuariocdi@gmail.com',
  'supportName' => 'Laura Duperret Gómez',
  'supportPhone' => '+57-1 2970200',
...
<li class="show"><a href="http://www.cavelier.com">Asociación Cavelier del Derecho</a></li>
  ...
  'authorGuidelines' => 
  array (
    'en_US' => '<p>The articles submitted must be <strong>original and unpublished</strong>, that is, they cannot be published in print or digital media; neither can they be in evaluation or have editorial commitments with another publication. Authors may submit their articles through the OJS platform on the link that says "online submissions" or by email anuariocdi@gmail.com during the dates established in the calls published by the journal (February).</p><p>The authors must certify their authorship by sending the <a title="Publication authoirzation" href="http://revistas.urosario.edu.co/index.php/crai/article/viewFile/5263/3549" target="_blank"><strong>publication authorization</strong></a> fully filled in and signed. In case of having several authors, each one should fill out the form and send it to the journal when making the submission. If graphic or statistical material is used that is not property of the authors, they should be the ones who manage the permits for the use of said information with the competent authorities.</p><p>The author (s) accepts that the receipt of the document by the journal does not imply a commitment to publish. Keep in mind that the processes of reception, peer evaluation and publication do not entail costs for the authors.</p>',
    'es_ES' => '<p><span>Los artículos presentados para el proceso de publicación de la revista deben ser originales e inéditos, es decir, no pueden estar publicados en medios impresos o digitales. Tampoco pueden estar en proceso de evaluación o tener compromisos editoriales con otra publicación. </span>Los autores podrán remitir sus artículos a través de la plataforma OJS<strong> </strong>en el enlace que dice “envíos en línea” o por correo electrónico <a href="mailto:anuariocdi@gmail.com">anuariocdi@gmail.com</a> durante las fechas establecidas en las convocatorias publicadas por la revista en el mismo portal <a href="/index.php/acdi/index">http://revistas.urosario.edu.co/index.php/acdi/index</a> o en la página <a href="http://www.anuariocdi.org/">www.anuariocdi.org</a></p><p>Los autores deben certificar que el artículo es de su autoría, remitiendo diligenciada y firmada la <a title="Autorización de publicación" href="http://revistas.urosario.edu.co/index.php/crai/article/viewFile/5263/3549" target="_blank"><strong>autorización de publicación</strong></a>. En caso de tener varios autores, cada uno deberá diligenciar el formato y remitirlo a la revista en el momento de postular el artículo. Si se utiliza material gráfico o estadístico que no sea propiedad de los autores, deberán ser éstos quienes gestionen los permisos de uso de dicha información con las autoridades competentes.</p><p>El (los) autor(es) acepta(n) que la recepción del documento por parte de la revista no implica compromiso de publicación. Tenga en cuenta que l<span>os procesos de revisión, evaluación por pares y publicación no acarrean costos para los autores.</span></p><p>El documento presentado debe estar clasificado dentro de alguna de las siguientes categorías:</p><ul><li><em>Artículo de investigación científica y tecnológica</em>: Documento que presenta, de manera detallada, los resultados originales de proyectos de investigación. La estructura generalmente utilizada tiene cuatro partes importantes: introducción, metodología, resultados y conclusiones.</li><li><em>Artículo de reflexión</em>: Documento que presenta resultados de investigación desde una perspectiva analítica, interpretativa o crítica, sobre un tema específico, recurriendo a fuentes originales.</li><li><em>Artículo de revisión:</em> Documento resultado de una investigación donde se analizan, sistematizan e integran los resultados de investigaciones publicadas o no publicadas, sobre un campo en ciencia o tecnología, con el fin de dar cuenta de los avances y las tendencias de desarrollo. Se caracteriza por presentar una cuidadosa revisión bibliográfica de por lo menos cincuenta (50) referencias</li></ul><p>[1] Clasificación tomada del documento "Orientaciones generales de la actualización del índice de  publicaciones seriadas científicas y tecnológicas colombianas", Colciencias, 2002.</p><ul><li>Para aplicar a cualquier categoría el artículo debe incluir un aparte de conclusiones.</li><li>Para todos los artículos de investigación debe incluirse siempre una descripción del método, los resultados y las fuentes.</li></ul>',
    'pt_BR' => '<p>Aos autores poderão remitir os seus artigos através da plataforma OJS no link que diz “envíos en línea” ou por correio eletrônico anuariocdi@gmail.com durante as datas estabelecidas nas convocatórias publicadas pela revista no mesmo site http://revistas.urosario.edu.co/index.php/acdi/index ou no site www.anuariocdi.org</p><p>Os autores devem certificar que o artigo é da sua autoria, remitindo preenchida e assinada a “autorização de publicação”. Em caso de ter vários autores, cada um deverá diligenciar o formato e remiti-lo à revista no momento de postular o artigo. Se se utiliza material gráfico ou estatístico que não seja propriedade dos autores, deverão ser eles quem peçam as permissões de uso de dita informação com as autoridades competentes.</p><p>O (s) autor (es) aceita (m) que a recepção do documento por parte da revista não implica compromisso de publicação.</p><p>O documento apresentado deve estar classificado dentro de alguma das seguintes categorias:</p><ul><li><em>Artigo de investigação científica e tecnológica:</em> Documento que apresenta, de maneira detalhada, os resultados originais de projetos de investigação. A estrutura geralmente utilizada tem quatro partes importantes: introdução, metodologia, resultados e conclusões.</li><li><em>Artigo de reflexão:</em> Documento que apresenta resultados de investigação desde uma perspetiva analítica, interpretativa ou crítica, sobre um tema específico, recorrendo a fontes originais.</li><li><em>Artigo de revisão:</em> Documento resultado de uma investigação onde se analisam, sistematizam e integram os resultados de investigações publicadas ou não publicadas, sobre um campo em ciência ou tecnologia, com o fim de dar conta dos avanços e as tendências de desenvolvimento. Se caracteriza por apresentar uma cuidadosa revisão bibliográfica de pelo menos cinquenta (50) referências.</li></ul><p>[1] Classificação tomada do documento "Orientações gerais da atualização do índice de publicações seriadas científicas e tecnológicas colombianas", Colciencias, 2002.</p><ul><li>Para aplicar a qualquer categoria o artigo deve incluir um aparte de conclusões.</li><li>Para todos os artigos de investigação deve incluir-se sempre uma descrição do método, os resultados e as fontes.</li></ul>',
  ),
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/index.php/acdi/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/index.php/acdi/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/index.php/acdi/user/register">register</a> with the journal prior to submitting, or if already registered can simply <a href="/index.php/index/login">log in</a> and begin the 5 step process.',
    'es_ES' => '¿Tiene interés en hacer un envío a esta revista? Le recomendamos que revise la sección <a href="/index.php/anuario/about">Acerca de la revista</a><a> para consultar la política de la misma, así como las </a><a href="/index.php/anuario/about/submissions#authorGuidelines">Normas de autores</a>. Los autores necesitan <a href="/index.php/anuario/user/register">registrarse</a> en la revista para poder hacer envíos, o si ya están registrados pueden simplemente <a href="/index.php/index/login">identificarse</a> y empezar el proceso de 5 pasos.',
    'fr_CA' => 'Intéressé à faire une soumission à cette revue? Nous vous recommandons de consulter les rubriques de la revue à la page <a href="http://revistas.urosario.edu.co/index.php/acdi/about">Au sujet de la revue</a> <a href="http://revistas.urosario.edu.co/index.php/acdi/about/submissions#authorGuidelines">Instructions aux auteurs</a>. Les auteurs doivent <a href="http://revistas.urosario.edu.co/index.php/acdi/user/register">s\'inscrire</a> auprès de la revue avant de présenter une soumission, ou s\'ils sont déjà inscrits, simplement <a href="http://revistas.urosario.edu.co/index.php/index/login">ouvrir une session</a> et commencer les 5 étapes du processus.',
  ),
...
Après que le texte a été évalué par le rédacteur et l\'auteur, l\'évaluateur revoit une dernière fois le texte et accepte les modifications en préparation du travail éditorial et de l\'épreuve en placard. 


<strong>2. Harvard Educational Review</strong>

<strong>Comment procéder aux révisions électroniques du manuscrit</strong>

Veuillez suivre le protocole suivant pour faire les révisions électroniques de votre manuscrit:

<strong>Répondre aux modifications suggérées</strong>
&nbsp; Pour chaque modification suggérée que vous acceptez, enlever le gras du texte
&nbsp; Pour chaque modification suggérée que vous refusez, remettre le texte original et le mettre en <strong>gras</strong>

<strong>Adjonctions et suppressions</strong>
&nbsp; Indiquer les adjonctions en <strong>mettant en gras</strong> le nouveau texte
&nbsp; Remplacer les rubriques supprimées par: <strong>[texte supprimé]</strong>
&nbsp; Si vous supprimez une phrase ou plus, veuillez l\'indiquer dans une note, par ex., <strong>[ ai supprimé 2 phrases]</strong>

<strong>Répondre aux requêtes de l\'auteur (QetR)</strong>
&nbsp; Garder toutes les QetR intactes et en gras dans le texte. Ne pas les supprimer &nbsp; Pour répondre à une QetR, ajouter un commentaire après. Les commentaires doivent être limités Ã  :
<strong>[Commentaire :</strong>]
&nbsp; par ex., <strong>[Commentaire : Discussion élargie de la méthodologie comme vous l\'avez suggéré]</strong>

<strong>Apporter des commentaires</strong>
&nbsp; Utiliser les commentaires pour expliquer les modifications organisationnelles ou les révisions majeures
&nbsp; par ex., <strong>[Commentaire : Déplacer le paragraphe ci-dessus de la p. 5 à la p. 7]</strong>
&nbsp; Nota : Lors du renvoi à des numéros de page, veuillez utiliser les numéros de page de la copie imprimée du manuscrit qui vous a été envoyée. Cela est important car les numéros de page peuvent changer lorsqu\'un document est révisé électroniquement.

<h4>Illustration d\'une révision électronique</h4>

<strong>Fichier " manuscrit " original</strong>

Avant d\'apporter des changements importants à la structure ou à l\'organisation de votre manuscrit original, veuillez communiquer avec les co-évaluateurs de votre article. Après que vous avez terminé vos révisions, changer le nom du fichier AuthorNameQA.doc pour AuthorNameQAR.doc (par ex., de GagnonQA.doc à GagnonQAR.doc). Imprimer une copie papier de votre manuscrit et la poster avec une disquette contenant le fichier de traitement de texte complètement révisé et renommé. 


<strong>Manuscrit retourné à l\'auteur avec requêtes et suggestions</strong>

Avant d\'apporter des changements importants à la structure ou à l\'organisation <strong>du manuscrit que nous vous retournons</strong>, veuillez communiquer avec les <strong>les rédacteurs  qui révisent</strong> votre article. Après que vos modifications sont terminées, changer le nom du fichier AuthorNameQA.doc pour AuthorNameQAR.doc (par ex., de Gagnon QA.doc à GagnonQAR.doc). Imprimer une copie papier de votre manuscrit et la poster avec une disquette contenant le fichier de traitement de texte complètement révisé et renommé. <strong>[QetR : Dans ce paragraphe, il serait utile d\'insister sur l\'importance de suivre attentivement les instructions pour la présentation des révisions électroniques. Sinon, le processus de publication pourrait être considérablement ralenti.]</strong>
 
<strong>Manuscrit révisé retourné à HER</strong>

Avant d\'apporter des changements importants à la structure et à l\'organisation du manuscrit que nous vous retournons, veuillez communiquer avec les <strong>rédacteurs qui révisent</strong> votre article. Sinon, le processus de publication pourrait être considérablement ralenti.</strong>

Après que vos révisions sont terminées, changer le nom du fichier AuthorNameQA.doc pour AuthorNameQAR.doc (par ex., de GagnonQA.doc à GagnonQAR.doc). Imprimer une copie papier de votre manuscrit et la poster avec une disquette contenant le fichier de traitement de texte <strong>[mot supprimé</strong> révisé et renommé. <strong>[QetR : Dans ce paragraphe, il serait utile d\'insister sur l\'importance de suivre attentivement les instructions pour la présentation des révisions électroniques. Sinon, le processus de publication pourrait être considérablement ralenti.] [Commentaire : J\'ai ajouté une phrase en réponse à votre suggestion.]</strong>

<strong>Notes :</strong>
&bull; La suppression du gras dans le texte indique que vous acceptez les modifications suggérées à la première phrase.
&bull; Phrase ajoutée en réponse à QetR. Le texte en gras indique un ajout au nouveau texte
&bull; [mot supprimé] indique la suppression de "entièrement "
&bull; Le commentaire contient une réponse aux QetR des rédacteurs',
  ),
  'customAboutItems' => 
  array (
    'en_US' => 
  ...
  'description' => 
  array (
    'en_US' => '<p><strong>ISSN-e:</strong> 2145-4493 <br> <strong>ISSN:</strong> 2027-1131 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/acdi">http://dx.doi.org/10.12804/acdi</a></p>',
    'es_ES' => '<p><strong>ISSN-e:</strong> 2145-4493 <br> <strong>ISSN:</strong> 2027-1131 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/acdi">http://dx.doi.org/10.12804/acdi</a></p>',
    'pt_BR' => '<p><strong>ISSN-e:</strong> 2145-4493 <br> <strong>ISSN:</strong> 2027-1131 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/acdi">http://dx.doi.org/10.12804/acdi</a></p>',
  ),
  ...
  array (
    ...
    'fr_CA' => 'Les dons à cette revue, quels que soient le montant, sont les bienvenus et permettent aux éditeurs de continuer à offrir une revue de la plus haute qualité à ses lecteurs.',
  ),
  'donationFeeName' => 
  array (
    'en_US' => 'Donations to journal',
    'es_ES' => 'Donaciones a la revista',
    'fr_CA' => 'Dons à la revue',
  ),
  'editorialTeam' => 
  array (
    'en_US' => '<div id="group">
...
<p>Laura Duperret, Colombia</p>
  ...
  array (
    ...
    'fr_CA' => 'Avec le paiement de ces frais, la révision, la décision éditoriale et la notification à l\'auteur de ce manuscrit sont garanties dans les quatre prochaines semaines.',
  ),
  'fastTrackFeeName' => 
  array (
    'en_US' => 'Fast-Track Review',
    'es_ES' => 'Revisión rápida',
    'fr_CA' => 'Révision accélérée',
  ),
  'focusScopeDesc' => 
  array (
    'en_US' => '<p>The Yearbook is published annually. It is an academic journal affiliated with the School of Law at the Universidad del Rosario in Bogotá, Colombia, and edited with the assistance of the <em>Asociación Cavelier del Derecho</em>. The Editor, Editorial Committee, and Scientific Committee of the Yearbook guarantee the relevance and quality of the articles it publishes. The Yearbook accepts research, reflection, and review articles dedicated exclusively to areas of International Law including Public International law, Private International Law, International Human Rights Law, International Economic Law, and International Investment Arbitration. It publishes articles in Spanish, English, French, and Portuguese, all the official languages of the Organization of American States (OAS), since the OAS is the first regional organization to regulate all matters concerning International Law in the American Hemisphere. In addition, the Yearbook provides a space for young internationalists to publish their research results with the help of recognized figures in International Law, and thereby achieve recognition in the Colombian and international academic community.</p>',
    'es_ES' => 'El Anuario Colombiano de Derecho Internacional es una revista académica de periodicidad anual, adscrita a la Facultad de Jurisprudencia de la Universidad del Rosario –Colombia, que se edita con el apoyo de la Fundación Cavelier del Derecho. Cuenta con un Editor, un Comité Editorial y un Comité Científico que garantizan la pertinencia y calidad de los artículos publicados. Recibe artículos de investigación, reflexión y revisión relacionados únicamente con temas de Derecho Internacional bien sea en áreas de Derecho Internacional Público, Derecho Internacional Privado, Derecho Internacional de los Derechos Humanos, Derecho Internacional Económico y Arbitraje Internacional de Inversión. Además publica artículos en cualquiera de los idiomas oficiales de la Organización de los Estados Americanos - OEA, es decir, castellano, inglés, francés y portugués, por ser esta la primera organización regional que regula todo lo relativo al Derecho Internacional en el hemisferio americano. Así mismo, el Anuario pretende abrir un espacio a los jóvenes internacionalistas para que, de la mano de aquellos que gozan ya de un reconocimiento, publiquen sus <span>investigaciones para así darlas a conocer a la comunidad académica nacional e internacional. </span>',
    'pt_BR' => '<p>O Anuário Colombiano de Direito Internacional é uma revista acadêmica de periodicidade anual, adscrita à Faculdade de Jurisprudência da Universidad del Rosario – Colômbia, que se edita com o apoio da Fundação Cavelier do Direito. Conta com um Editor, um Comité Editorial e um Comité Científico que garantem a pertinência e qualidade dos artigos publicados. Recebe artigos de investigação, reflexão e revisão relacionados unicamente com temas de Direito Internacional seja nas Áreas de Direito Internacional Público, Direito Internacional Privado, Direito Internacional dos Direitos Humanos, Direito Internacional Econômico e Arbitragem Internacional de Investimento. Além disso publica artigos em qualquer língua oficial da Organização dos Estados Americanos – OEA, é dizer, castelhano, inglês, francês e português, por ser esta a primeira organização regional que regula todo o relativo ao Direito Internacional no hemisfério americano. Igualmente, o anuário pretende abrir um espaço aos jovens internacionalistas para que, da mão daqueles que desfrutam já de um reconhecimento, publiquem as suas investigações para assim dá-las a conhecer à comunidade acadêmica nacional e internacional. </p>',
  ),
  'homeHeaderTitle' => 
  array (
    'en_US' => 'Colombian Yearbook of International Law',
    'es_ES' => 'Anuario Colombiano de Derecho Internacional',
  ),
  ...
  array (
    ...
    'fr_CA' => 'Nous incitons les bibliothèques à indiquer l\'accès libre à cette revue parmi les revues électroniques qu\'elles conservent. Ce système de publication est aussi conçu pour être hébergé et exploité par les bibliothèques de recherche afin de soutenir les travaux des membres de ses facultés associées publiés dans la revue. Pour en savoir plus sur l\'utilisation de Open Journal Systems pour gérer et publier les revues évaluées par les pairs, voir <a href="http://pkp.sfu.ca">Public Knowledge Project</a>.',
  ),
  'lockssLicense' => 
  array (
    ...
    'fr_CA' => 'Cette revue utilise le système LOCKSS pour créer un système de distribution des archives parmi les bibliothèques participantes et permet à ces bibliothèques de créer des archives permanentes pour fins de préservation et de restauration. <a href="http://lockss.org/">More...</a>',
  ),
  ...
  array (
    ...
    'fr_CA' => 'Le paiement des frais vous inscrira à titre de membre de cette association pendant un an et vous accordera un accès gratuit à ce journal.',
  ),
  'membershipFeeName' => 
  array (
    'en_US' => 'Association Membership',
    'es_ES' => 'Afiliación a la asociación',
    'fr_CA' => 'Adhésion à l\'Association',
  ),
  'name' => 
  array (
    'en_US' => 'Colombian Yearbook of International Law - CYIL',
    'es_ES' => 'ACDI - Anuario Colombiano de Derecho Internacional',
    'fr_CA' => 'Annuaire Colombien de Droit International - ACDI',
  ),
  'openAccessPolicy' => 
  array (
    ...
    'es_ES' => 'Esta revista provee acceso libre inmediato a su contenido bajo el principio de que hacer disponible gratuitamente investigación al publico y apoya a un mayor intercambio de conocimiento global.',
    'fr_CA' => 'Cette revue procure un libre accès immédiat à son contenu se basant sur le principe qu\'en mettant la recherche publiquement disponible facilite un plus grand échange du savoir, à l\'échelle de la planète.',
  ),
  'privacyStatement' => 
  array (
    ...
    'fr_CA' => 'Les noms et adresses électroniques entrés dans ce site de la revue seront utilisés exclusivement aux fins indiquées de cette revue et ne serviront à aucune autre fin, ni à toute autre partie.',
  ),
  'proofInstructions' => 
  array (
...
El tercer párrafo no está justificado.</pre>',
    'fr_CA' => '<p>L\'étape de correction d\'épreuves vise à corriger toute erreur dans le formatage, la grammaire et l\'orthographe de l\'épreuve en placard. Des changements plus considérables ne peuvent être effectués à cette étape, à moins que cela ne soit discuté avec l\'éditeur de la section. Dans Mise en page, cliquer sur VISIONNER L\'ÉPREUVE pour voir le HTML, le PDF et d\'autres formats de fichiers disponibles utilisés dans la publication de cet article.</p>
<h4>Pour les erreurs de grammaire et d\'orthographe</h4>

<p>Copier le mot problème ou les groupes de mots et les coller dans la case Corrections d\'épreuves avec les directives « CHANGER À » à l\'éditeur comme suit...</p>
...
<h4>Pour les erreurs de formatage</h4>

<p>Décrire l\'emplacement et la nature du problème dans la case Corrections d\'épreuves après avoir entré le titre « FORMATAGE » comme suit...</p>
<br />
<pre>3. FORMATAGE
Les chiffres dans le tableau 3 ne sont pas alignés dans la troisième colonne.</pre>
<br />
<pre>4. FORMATAGE
Le paragraphe qui commence « Ce dernier sujet... » est à effacer. </pre>',
  ),
  ...
  array (
    ...
    'fr_CA' => 'Si cet article est accepté pour fin de publication, vous devrez payer les frais de publication d\'article pour couvrir les frais de publication.',
  ),
  'publicationFeeName' => 
  array (
    'en_US' => 'Article Publication',
    'es_ES' => 'Publicación de artículo',
    'fr_CA' => 'Publication d\'article',
  ),
  ...
  array (
    ...
    'fr_CA' => 'Le paiement de ces frais vous permettra d\'afficher, de télécharger sur votre poste, et d\'imprimer cet article.',
  ),
  'purchaseArticleFeeName' => 
  array (
    'en_US' => 'Purchase Article',
    'es_ES' => 'Comprar Artículo',
    'fr_CA' => 'Acheter un article',
  ),
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/index.php/acdi/user/register">Register</a> link at the top of the homepage for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/index.php/acdi/about/submissions#privacyStatement">Privacy Statement</a> which assures readers that their name and email address will not be used for other purposes.',
    'es_ES' => 'Recomendamos a Los lectores que se den de alta en el servicio de notificación de publicación de esta revista. Use el enlace de <a href="/index.php/anuario/user/register">Registro</a> que se encuentra arriba en la home de la revista. Este registro permitirá al lector recibir la Tabla de contenidos por correo-e cada vez que se publique un nuevo número de la revista. Esto también permitirá a la revista conseguir un cierto nivel de soporte y número de lectores. Consulte la <a href="/index.php/anuario/about/submissions#privacyStatement">Política de Privacidad</a> de la revista, que asegura a Los lectores que su nombre y dirección de correo-e no serán usados para otros propósitos.',
    'fr_CA' => 'Nous incitons les lecteurs à s\'inscrire pour recevoir les avis de publication pour cette revue. Utiliser le <a href="http://revistas.urosario.edu.co/index.php/acdi/user/register">Inscrire</a> le lien en haut de la page d\'accueil de la revue. Cette inscription permettra au lecteur de recevoir par courriel la table des matières de chaque nouveau numéro de la revue. Cette liste permet aussi à la revue d\'inscrire un certain niveau de soutien ou de lectorat. Voir la rubrique de la revue <a href="http://revistas.urosario.edu.co/index.php/acdi/about/submissions#privacyStatement">Protection des données personnelles</a> qui confirme aux lecteurs que leur nom et leur adresse électronique ne seront pas utilisés à d\'autres fins.',
  ),
  'refLinkInstructions' => 
  array (
    ...
    'fr_CA' => '<h4>Pour ajouter un lien aux références du processus de mise en page</h4>
	<p>Quand vous convertissez une soumission en format HTML ou PDF, assurez-vous que tous les hyperliens dans les soumissions son actifs.</p>
	<h4>A. Quand l\'auteur fournit un lien avec la référence</h4>
	<ol>
	<li>Quand la soumission est encore dans son format de traitement de texte (p. ex. : Word), ajouter la phrase VISIONNER ARTICLE à la fin de la référence possédant un URL.</li>
	<li>Convertir cette phrase en hyperlien en la surlignant et en utilisant l\'outil d\'insertion d\'hyperliens de Word et le URL préparé au no 2.</li>
	</ol>
	<h4>B. Permettre aux lecteurs d\'utiliser Google pour les références</h4>
	<ol>
	<li>Quand la soumission est encore dans son format de traitement de texte (p. ex. : Word), copier le titre de l\'ouvrage concerné dans la liste Références (si le titre semble être trop commun – p. ex. : « Paix » - copier alors l\'auteur et le titre).</li>
	<li>Coller le titre de la référence entre le %22, en mettant un + entre chaque mot : http://scholar.google.com/scholar?q=%22PASTE+TITLE+HERE%22&hl=en&lr=&btnG=Search</li>
	<li>Ajouter la phrase RECHERCHE CG à la fin de chaque citation dans la liste de références de la soumission.</li>
	<li>Convertir cette phrase en un hyperlien en la surlignant et en utilisant l\'outil d\'insertion d\'hyperliens de Word et le URL préparé au no 2.</li>
	</ol>
	<h4>C. Permettre aux lecteurs de chercher des références avec un DOI</h4>
	<ol>
	<li>Quand la soumission est encore en format Word, copier le groupe de références dans la demande de texte de référence croisée http://www.crossref.org/freeTextQuery/</li>
	<li>Copier chaque DOI fourni par la demande dans l\'URL suivant (entre = and &) : http://www.cmaj.ca/cgi/external_ref?access_num=PASTE DOI#HERE&link_type=DOI</li>
	<li>Ajouter la phrase Référence croisée à la fin de chaque citation dans la liste de références de la soumission.</li>
	<li>Convertir cette phrase en un hyperlien en la surlignant et en utilisant l\'outil d\'insertion d\'hyperliens de Word et le URL préparé au no 2.</li>
	</ol>',
  ),
  'reviewGuidelines' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => '<p>The document being submitted should be classified in one of the following categories:</p><p><strong>Scientific or technological research article</strong>: A document that presents original and detailed results of research projects. The usual structure consists of four important sections: introduction, methodology, results, and conclusions.</p><p><strong>Article of reflection</strong>: A document that presents research results from an analytical, interpretive, or critical perspective regarding a specific topic, making use of original sources.</p><p><strong>Review article</strong>: A document resulting from an investigation in which the author analyzes, systematizes, and integrates the results of published or unpublished research projects in a scientific or technological field, recognizing and disseminating information about scientific progress and trends in scientific development. These articles provide a careful bibliographic review of at least fifty (50) references.</p><p>[1] Classifications taken from the document General Guide to the Updated Index of Colombian Serial Publications in Science and Technology (<em>Orientaciones generales de la actualización del índice de publicaciones seriadas científicas y tecnológicas colombianas</em>), Colciencias, 2002.</p><p>Articles in any of these categories must include a section presenting conclusions.</p><p>All research articles must include descriptions of methods, results, and sources.</p>',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => '<p><strong>Authors must also provide the following:</strong></p><p>When submitting an article, authors must also send the following documents:</p><p><em>Cover page:</em> The cover page must include the name of the article in Spanish and English, the name of the author or authors, their institutional affiliation indicating city and country, source of financing for the research project, a brief summary of the author or authors’ CVs (maximum four lines per CV), and their institutional email addresses. The author should also indicate if the article has been presented at any meeting or congress or whether it was written for a presentation.</p><p><em>Abstract and keywords:</em> The author or authors should attach an abstract of the article in both English and Spanish, each comprising no more than one hundred twenty (120) words. The abstract should be succinct and should very briefly present the goal, the methodology, the results, and the conclusions of the article in such a way that the reader will get a full idea of the document’s contents at its first reading. A maximum of five key words should be provided in both English and Spanish to facilitate the indexing of the article.</p><p><em>Authorization to publish</em>: The author or authors should complete the authorization to publish, sign it physically or electronically, and send it to the journal. The authorization to publish is available to authors on the journal’s webpage. This authorization is a required step in the submission of a manuscript. </p>',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => '<p><strong>General instructions for submitting articles</strong></p><p>Length: maximum 30 pages (8,000 to 10,000 words including bibliographical references)</p><p>Margins: 3 cm (1.2 inches) on each side of the page</p><p>Spacing: double-spaced, including block quotes. Do not insert tabs or extra spaces between paragraphs. Do not use page breaks.</p><p>Font: Times New Roman, 12-point</p><p>Page numbers: lower right corner on every page</p><p>Title: In Spanish and English. If the document is written in another language include a Spanish and an Enlglish translation of its title.</p><p>Authors: the complete name of the author or authors should appear beneath the title of the document.</p><p>A short biography of the authors (maximum of 4 lines each) should be provided in a footnote, including institutional affiliation, current position, and e-mail address.</p><p>Footnotes should be for the purpose of clarification, not to provide bibliographical information, except in the case of a complementary reference.</p><p>The abstract should be 120 words long, and should be provided in both Spanish and English. It must provide the main idea of the text and information regarding the methodology of the research, its development, and the conclusions that were reached.</p><p>References should be provided in a list at the end of the article.</p><p>Section headings should be consecutive, using only three levels formatted in the following manner:</p><p>1. <strong>Title 1</strong></p><p>1.1. Second level subtitle</p><p>1.1.1. Third level subtitle</p><p>2. <strong>Title 2</strong></p><p>If figures or tables are included, a maximum of two colors per figure is recommended. It is the author’s responsibility to obtain all permissions and rights to include materials or illustrations that come from other sources.</p>',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => '<p>Bibliographical references should be organized alphabetically and should adhere to <strong>Chicago style, </strong><a href="https://www.chicagomanualofstyle.org/tools_citationguide/citation-guide-1.html" target="_blank">https://www.chicagomanualofstyle.org/tools_citationguide/citation-guide-1.html</a></p>',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => '<p>The text adheres to the stylistic and bibliographic requirements outlined in the <a href="/index.php/acdi/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.</p><p>The text is single-spaced; uses a 12-point font; employs italics, rather than underlining (except with URL addresses); and all illustrations, figures, and tables are placed within the text at the appropriate points, rather than at the end</p>',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://revistas.urosario.edu.co/index.php/acdi/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
      ),
    ),
    'es_ES' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => '<p><strong>Adicionalmente el autor debe incluir:</strong></p><p>En el momento de la postulación de un artículo, se deben incluir los siguientes documentos:</p><ul><li><em>Portada:</em> la página de portada debe tener el título del artículo en español y en inglés, el nombre del (los) autor(es), filiación institucional indicando país y ciudad, fuente de financiación del proyecto de investigación y un breve resumen de la hoja de vida del (los) autor(es) en máximo cuatro (4) líneas con el código ORCID de cada investigador y la dirección electrónica institucional. Adicionalmente, se debe indicar si el artículo ha sido presentado en algún congreso o si ha sido escrito para una ponencia.</li></ul><em><br /></em><ul><li><em>Resumen y palabras clave:</em> el (los) autor(es) deberán anexar un resumen de su artículo, no mayor a ciento veinte (120) palabras en español y en inglés. El texto de resumen debe ser sucinto y presentar muy brevemente el objetivo, la metodología, los resultados y conclusiones de manera que el lector pueda hacerse una idea completa del documento en su primera lectura. Igualmente, deben indicar las palabras clave que faciliten la indexación del artículo (máximo cinco), tanto en español como en inglés.</li></ul><em><br /></em><ul><li><em>Autorización para publicación:</em> el (los) autores deben diligenciar la autorización de publicación y hacerla llegar firmada por medio físico o electrónico. La autorización de publicación se encuentra en la página de la revista a disposición de los interesados. Este es un requisito indispensable para hacer la postulación del artículo.</li></ul><ul><li>Para descargar la autorización de publicación siga el siguiente link:</li></ul><p><a href="/index.php/crai/article/viewFile/5263/3549" target="_blank"><span style="font-family: Calibri, sans-serif; font-size: small;"><span>http://revistas.urosario.edu.co/index.php/crai/article/viewFile/5263/3549</span></span></a></p>',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => '<p><strong>Instrucciones generales para presentación de </strong><strong>los artículos</strong></p><ul><li><em>Extensión</em>: máximo 30 páginas (8000 a 10000 palabras incluyendo las referencias bibliográficas)</li><li><em>Márgenes:</em> 3 cm en cada uno de los lados de la hoja.</li><li>Interlineado: doble espacio, incluso las citas textuales. No inserte tabuladores o espacios extra entre parágrafos. No inserte rompimientos de página.</li><li><em>Tipografía o fuente</em>: Times New Roman, tamaño 12 puntos</li><li>Paginación: esquina inferior derecha de cada página</li><li><em>Título:</em> En español y en inglés. Si el documento está escrito en otro idioma debe considerar las tres opciones.</li><li><em>Autores:</em> Debajo del título debe aparecer el nombre completo del autor o autores del documento</li><li><em>Reseña de los autores:</em> pequeña biografía del autor (máximo 4 líneas) con filiación institucional, cargo actual, código ORCID del investigador y correo electrónico. Toda la información en pie de página.</li><li><em>Notas de pie de página:</em> deben ser de carácter aclaratorio y no con el fin de presentar la bibliografía, a menos que sea una referencia complementaria.</li><li><em>Resumen:</em> debe presentar brevemente (120 palabras, tanto en español como en inglés) la idea principal del texto y dar cuenta de la metodología, desarrollo y conclusiones de la investigación.</li><li><em>Lista de referencias:</em> se ubican al final del artículo utilizando.</li><li><em>Jerarquía de titulación:</em> debe ser consecutiva y utilizar únicamente tres niveles así:</li></ul><p>1. <strong>Título 1</strong></p><p>1.1. Subtítulo de segundo nivel</p><p>1.1.1. Subtítulo de tercer nivel</p><p>2. <strong>Título 2</strong></p><p>Si se incluyen figura o tablas, se recomienda un máximo de dos colores por figura. Es responsabilidad del autor obtener los permisos y derechos para incluir materiales o ilustraciones provenientes de otras fuentes.</p>',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => '<p><strong>Citas y referencias</strong></p><p>Las referencias bibliográficas deberán estar hechas de acuerdo con las normas <strong>Chicago, notes and bibliography </strong><a href="https://www.chicagomanualofstyle.org/tools_citationguide/citation-guide-1.html" target="_blank">https://www.chicagomanualofstyle.org/tools_citationguide/citation-guide-1.html</a></p>',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => 'El texto tiene interlineado simple; el tamaño de fuente es 12 puntos; se usa cursiva en vez de subrayado (exceptuando las direcciones URL); y todas las ilustraciones, figuras y tablas están dentro del texto en el sitio que les corresponde y no al final del todo.',
      ),
    ),
    'fr_CA' => 
    array (
      0 => 
      array (
        'content' => 'La soumission n\'a pas été précédemment publiée, et elle ne précède pas une autre revue pour examen (ou une explication a été fournie dans Commentaires au rédacteur).',
        'order' => '1',
      ),
      1 => 
      array (
        'content' => 'Le fichier de la présentation est en format de fichier document Microsoft WORD, RTF, ou WordPerfect.',
        'order' => '2',
      ),
      2 => 
      array (
        'content' => 'Quand cela a été possible, les URL des références ont été offerts.',
        'order' => '3',
      ),
      3 => 
      array (
        'content' => 'Le texte est à simple interligne; utiliser une police à 12 points; employer l\'italique plutôt que le souligné (sauf pour les adresses URL); et placer toutes les illustrations, figures, et tables aux endroits appropriés dans le texte plutôt qu\'à la fin.',
        'order' => '4',
      ),
      4 => 
      array (
        'content' => 'Le texte se conforme aux exigences stylistiques et bibliographiques décrites dans <a href="http://revistas.urosario.edu.co/index.php/acdi/about/submissions#authorGuidelines">Instructions aux auteurs</a>, qui se trouve dans « Au sujet de la revue ».',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'Dans le cas d\'une soumission à une rubrique évaluée par les pairs dans cette revue, les instructions dans <a href="javascript:openHelp(\'http://revistas.urosario.edu.co/index.php/acdi/help/view/editorial/topic/000044\')">S\'assurer d\'une évaluation en aveugle</a> ont été suivies.',
        'order' => '6',
      ),
    ),
    'pt_BR' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => '<p><strong>Adicionalmente o autor deve incluir:</strong></p><p>No momento da postulação de um artigo se devem incluir os seguintes documentos:</p><ul><li><em>Portada</em>: a página de portada deve ter o título do artigo em espanhol e em inglês, o nome do(s) autor(es), filiação institucional indicando país e cidade, fonte de financiamento do projeto de investigação e um breve resumo do currículo do(s) autor(es) em máximo quatro (4) linhas com o endereço eletrônico institucional. Além disso, deve-se indicar se o artigo tem sido apresentado em algum congresso ou se tem sido escrito para uma palestra.</li><li><em>Resumo e palavras-chave:</em> o(s) autor(es) deverão anexar um resumo do seu artigo, não maior a cento e vinte (120) palavras em espanhol e em inglês. O texto de resumo deve ser sucinto e apresentar muito brevemente o objetivo, a metodologia, os resultados e conclusões de forma que o leitor possa ter uma ideia completa do documento em sua primeira leitura. Igualmente, devem indicar as palavras-chave que facilitem a indexação do artigo (máximo cinco), tanto em espanhol quanto em inglês.</li><li><em>Autorização para publicação:</em> o(s) autor(es) devem diligenciar a autorização de publicação e enviá-la assinada por meio físico ou eletrônico. A autorização de publicação se encontra no site da revista a disposição dos interessados. Este é um requisito indispensável para fazer a postulação do artigo. </li></ul>',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => '<p><strong>Instruções gerais para apresentação dos artigos</strong></p><ul><li><em>Extensão:</em> máximo 30 páginas (8000 a 10000 palavras incluindo as referências bibliográficas)</li><li><em>Margens:</em> 3 cm em cada um dos lados da folha.</li><li><em>Espaçamento:</em> duplo espaço, inclusive as citas textuais. Não inserte tabuladores ou espaços extra entre parágrafos. Não inserte rompimentos de página.</li><li><em>Tipografia ou fonte:</em> Times New Roman, tamanho 12 pontos</li><li><em>Paginação:</em> esquina inferior direita de cada página</li><li><em>Título:</em> Em espanhol e em inglês. Se o documento está escrito em outra língua deve considerar as três opções.</li><li><em>Autores:</em> Debaixo do título deve aparecer o nome completo do autor ou autores do documento</li><li><em>Resenha dos autores:</em> pequena biografia do autor (máximo 4 linhas) com filiação institucional, cargo atual e correio eletrônico. Toda a informação em notas de rodapé.</li><li><em>Notas de rodapé</em>: devem ser de carácter esclarecedor e não com o fim de apresentar a bibliografia, a menos que seja uma referência complementária.</li><li><em>Resumo:</em> deve apresentar brevemente (120 palavras, tanto em espanhol como em inglês) a ideia principal do texto e dar conta da metodologia, desenvolvimento e conclusões da investigação.</li><li><em>Lista de referências:</em> se localizam no fim do artigo utilizando.</li><li><em>Hierarquia de titulação:</em> deve ser consecutiva e utilizar unicamente três níveis assim:</li></ul><p><strong>1. Título 1</strong></p><p>1.1. Subtítulo de segundo nível</p><p>1.1.1. Subtítulo de terceiro nível</p><p><strong>2. Título 2</strong></p><p>Se se incluem figuras ou tabelas, se recomenda um máximo de duas cores por figura. É responsabilidade do autor obter as permissões e direitos para incluir materiais ou ilustrações provenientes de outras fontes.</p>',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => '<p><strong>Referências</strong></p><p>As referências bibliográficas deverão estar feitas de acordo com as normas que indica a revista (ver a continuação), numeradas e organizadas alfabeticamente.</p><p>Todas as referências deverão estar citadas no texto ou nas tabelas com um número pequeno e sequencial à direita. No fim do documento é indispensável apresentar a lista de referências segundo o estilo indicado e na ordem a seguir:</p><p>1. Livros, capítulo de livro, artigos (organizados alfabeticamente)</p><p>2. Documentos</p><p>3. Jurisprudência</p><p>O autor é responsável da verificação das referências.</p><p> </p><p><strong>Utilize o seguinte estilo de referência</strong>:</p><p><em>Referências de livros:</em> Devem incluir (1) autor(es) (Se são mais de seis, inclua só os primeiros três nomes e adicione “et al” depois do terceiro nome). Se deve citar primeiro o sobrenome, logo o nome e se separam dos demais autores por coma (,). (2) título (em itálico), (3) edição, (4) editorial, (5) cidade, (6) ano, (7) páginas (use um hífen para separar o rango das páginas e a sigla p. se cita uma só página ou a sigla pp. se se citam várias páginas). Exemplo:</p><ul><li>De Soussa Santos, Boaventura, <em>Estado, derecho y luchas sociales</em>, ILSA, Bogotá, 1991, p. 127</li></ul><p> </p><p> <em>Referências de artigos de revistas:</em> Devem incluir (1) autor(es) (Se são mais de seis, inclua só os primeiros três nomes e adicione “et al” depois do terceiro nome). Lembre-se que se cita primeiro o sobrenome e logo o nome e se separam dos demais autores por coma (,). (2) título do artigo entre aspas, (3) nome da revista em itálico (4) ano, (5) Volume e/ou número (entre parêntesis), (6) páginas (utilize um hífen para separar o rango das páginas. Exemplo:</p><ul><li>Carlos Ariel Sánchez Torres. “El concepto constitucional de autonomía”, <em>Revista Estudios Socio-jurídicos</em>, 2003, 5, (1), pp. 172-210</li></ul><p> </p><p> <em>Referências de capítulos de livros:</em> Devem incluir (1) autor(es), (2) título do capítulo (entre aspas), em (3) autores do livro, (4) título do livro (em itálico), (5) edição, (6) cidade de publicação, (7) editorial (8) ano, (9) página (incluir só os número de página inicial e final separados por hífen). Exemplo:</p><ul><li>Fajardo Sánchez, Luis Alfonso, “Las voces multiculturales de la paz en Colombia”, em <em>Colombia paz y democracia</em>, CSIC-Universidad Pontificia Bolivariana, Madrid, 2000, pp. 137 y ss.</li></ul><p> </p><p><em>Referências de artigos buscados através da Internet</em>: Deve-se indicar os dados do artigo como se fosse artigo de revista e depois a expressão seguida do endereço eletrônico onde se buscou e a data de consulta. Exemplo:</p><ul><li>Ferro, Juan Guillermo. “Reflexiones en torno al caso colombiano”, em <em>Regional Workshop on Land Issues in Latin America and the Caribbean</em>, México, 2002, em www.desplazados.org consulta de setembro 9 de 2003.</li></ul><p> </p><p><em>Referência de artigos de jornal:</em> (1) Sobrenome e nome do autor. (2) Título do artigo (entre aspas), (3) nome do jornal (em itálico), (4) seção, (5) cidade, (6) data  e (7) número de página. Exemplo:</p><ul><li>Seitz, Maximiliano. “Hay un nuevo orden moral”, em <em>El Tiempo</em>, Lecturas Dominicales, Bogotá, 16 de janeiro de 2000, p.3</li></ul><p> </p><p><em>Referências de Jurisprudência</em>: (1) País, (2) Organismo Judicial, (3) Sala ou Seção, (4) Tipo de providência e número, (5) data da sentença, (6) magistrado ponente (7) Número de Expediente. Exemplo:</p><ul><li>Colômbia, Corte Suprema de Justiça, Sala de Cassação Civil e Agrária, sentença do 12 de agosto de 1997, magistrado apresentador José Fernando Ramírez Gómez, Expediente 4533</li></ul><p> </p><p><em>Referências de leis:</em> (1) país, (2) Organismo que ordena a norma, (3) Classe, número e data da norma. Exemplo:</p><ul><li>Colômbia, Congresso da República, Lei 472 de 1998.</li></ul><p> </p><p>O texto tem espaçamento simples; o tamanho de fonte é 12 pontos; se usa itálico em vez de sublinhado (a exceção dos endereços URL); e todas as ilustrações, figuras e tabelas estão dentro do texto no sítio que lhes corresponde e não no fim de texto.</p>',
      ),
    ),
  ),
  ...
  array (
    ...
    'fr_CA' => 'Les auteurs doivent payer des frais de soumission d\'article dans le cadre du processus de soumission afin de contribuer aux coûts de révision.',
  ),
  'submissionFeeName' => 
  array (
    'en_US' => 'Article Submission',
    'es_ES' => 'Envío de artículo',
    'fr_CA' => 'Soumission d\'article',
  ),
  'waiverPolicy' => 
  array (
    ...
    'fr_CA' => 'Si vous n\'êtes pas en mesure de payer de tels frais, vous aurez l\'occasion de supprimer les frais. Nous ne voulons pas que les frais empêchent la publication d\'ouvrages méritants.',
  ),
  'contactTitle' => 
  array (
    'es_ES' => 'Director - Editor',
  ),
  'copyrightNotice' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'width' => 326,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/php16WX9n\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:11:01',
    ),
  ),
  'homeHeaderTitleImageAltText' => 
  array (
    'es_ES' => 'Anuario Colombiano de Derecho Internacional - ACDI',
  ),
  'journalPageFooter' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'width' => 326,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpbEJtJ8\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:11:20',
    ),
  ),
  'publisherNote' => 
  array (
