<?php return array (
  ...
  'grid.action.editSubmissionChecklist' => 'Editar este elemento de la lista de control',
  'grid.action.deleteSubmissionChecklist' => 'Eliminar este elemento de la lista de control',
