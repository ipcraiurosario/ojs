<?php return array (
  ...
  array (
    'es_ES' => '<p><strong>Instructivo para el uso del control de cambios</strong></p><p>1. Con esta herramienta, el corrector marca las inserciones, supresiones y cambios de formato hechos en su texto. Usted debe revisar su texto, con el fin de verificar si está de acuerdo con las correcciones hechas. Igualmente, el corrector hizo comentarios o preguntas que el autor debe resolver en su totalidad.</p><p><strong>Importante: El autor no debe borrar ninguna de las modificaciones hechas por el corrector de estilo. El autor deberá limitarse a resaltar con verde los cambios con los cuales no está de acuerdo y con amarillo las nuevas palabras que introduzca.</strong></p><p>2. Abra el documento corregido.</p><p>3. En la esquina inferior derecha, verifique que el primer ícono esté activo: Al activarlo, usted verá los márgenes de la hoja.</p><p>4. En el menú superior vaya a ‘Revisar’ y al lado bajo se activara los ítems “Control cambios”, “marcas mostradas”, “mostrar marcas” y “panel de revisiones ’: Seguido de esto debe darle clic y activar “control cambios” luego en “panel de revisiones”. Seguido de esto deberá aparecer la siguiente columna de cambios al lado derecho de la pantalla:</p><p>5. De clic en el vínculo y luego deberá activar todas las casillas:</p><p>6. Una vez activada la columna le deberán aparecer los cambios que ha realizado en el documento. De este modo le aparecerán los cambios o ajustes que realizara al texto. Recuerde tener activado el control de cambios todo el tiempo. Seguido de esto, usted deberá dar clic en la pestaña control cambios para “cambiar las opciones de seguimiento”</p><p>7. Una vez en “opciones de seguimiento” elija:<br /> - En ‘Inserciones’, elija ‘Sólo color’ y el color ‘Azul’.<br /> - En ‘Eliminaciones’, elija ‘Tachado’ él y color ‘Rojo’:<br /> - En ‘Color para comentarios’ elija el color ‘Turquesa’:<br /> - En ‘Formato’, elija ‘Sólo color’ y el color ‘Verde’:<br /> - En ‘Usar globos (diseño de impresión y Web)’ elija la opción ‘Sólo para formato y comentarios’<br /> - Luego oprima "Aceptar".<br /> Para realizar comentarios sobre el texto usted deberá poner el curso sobre la línea a la cual desea darle un comentario dar clic sobre. Una vez hecho esto le aparecerá un cuadro al lado derecho del texto donde usted realizará el comentario.</p><p>8. Ahora su documento deberá tener una apariencia como ésta cuando empiece a realizar los cambios.</p><p>9. El color negro corresponde al texto original que no se modificó; el azul, al texto que el corrector insertó; el rojo tachado, al texto que el corrector quitó, y el verde, al texto que tuvo alguna modificación de formato (por ejemplo, estaba en letra normal y ahora está en letra cursiva).</p><p>10. Al margen derecho encontrará dos tipos de globos: uno con marco verde, que corresponde a los cambios de formato, y otro con color azul turquesa, que incluye un comentario o pregunta del corrector referido a la frase resaltada que aparece en el texto con el mismo color.</p><p>11. El autor debe responder todos los comentarios dentro del mismo globo. Para escribir dentro del globo sólo es necesario dar un clic en él. Ejemplo de respuesta:</p><p>12. Tenga en cuenta que buena parte de las palabras suprimidas (tachadas y en rojo), realmente no salieron del texto, sino que fueron cambiadas de lugar y usted las encontrará antes o después en color azul. Muchísimos cambios obedecen a aspectos puramente ortográficos (letras, tildes) o gramaticales (uso de preposiciones, conjugación de verbos, etc.). Los autores no deben prestar demasiada atención a estos cambios, pues la mayoría son sólo aplicaciones de normas de la Real Academia Española hechas por un corrector experto. Los autores deben fijarse mucho más en los cambios de palabras, en las supresiones o en posibles alteraciones del sentido de su texto. Por supuesto, puede haber cambios inadecuados.</p><p>13. Si el autor no está de acuerdo con un cambio, simplemente debe resaltarlo (con la función de resaltador que trae Word) con verde. No debe borrar ni usar las otras herramientas del control de cambios (esto lo hace el corrector de estilo).</p><p>14. Si el autor decide añadir alguna palabra o frase, debe resaltarla con amarillo (esto debe hacerse con mesura, pues si hay muchos cambios, el proceso de corrección se retrasará).</p>',
  ),
  ...
  'proofInstructions' => 
  array (
    'es_ES' => '<p>La fase "Pruebas" busca posibles errores en las galeradas, tanto gramaticales como de formato. En "Pruebas" pulse sobre "Ver Prueba" para revisar el Archivo.</p><h4>Erratas y Errores Gramaticales</h4><p>Copie las palabras problemáticas en la caja de correcciones, con instrucciones de "CAMBIAR POR" para el editor, tal y como sigue...</p><pre>1. CAMBIAR...<br />digo (en la tercera línea)<br />POR...<br />Diego</pre><br /><pre>2. CAMBIAR...<br />Malinowsky<br />POR...<br />Malinowski</pre><br /><h4>Errores de formato</h4><p>Describa la posición y tipo de problema en la caja de correcciones después de escribir la palabra "FORMATO", tal y como sigue...</p><br /><pre>3. FORMATO<br />Los números en la Tabla 3 no están alineados. </pre><br /><pre>4. FORMATO<br />El tercer párrafo no está justificado.</pre>',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    'es_ES' => 'Thesaurus of Psychological',
  ),
  'metaSubjectClassUrl' => 
  array (
    'es_ES' => 'http://thesaurus.reference.com/browse/psychological',
  ),
  'metaSubject' => false,
  'metaCoverage' => false,
  'metaType' => false,
  ...
  'name' => 
  array (
    'es_ES' => 'Avances en Psicología Latinoamericana',
    'en_US' => 'Avances en Psicología Latinoamericana',
  ),
  'acronym' => 
  array (
    'es_ES' => 'APL',
  ...
  'abbreviation' => 
  array (
    'es_ES' => 'Av. Psicol. Latinoam.',
    'en_US' => 'Av. Psicol. Latinoam.',
  ),
  'printIssn' => '1794-4724',
  'onlineIssn' => '2145-4515',
  'mailingAddress' => '<p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Programa de Psicología</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Escuela de Medicina y Ciencias de la Salud</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Carrera 24 # 63 C- 69 Quinta de Mutis</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Bogotá, D. C. Colombia</p>',
  'useCopyeditors' => true,
  'publishingMode' => 0,
  'showGalleyLinks' => false,
  'enableAnnouncements' => true,
  'useEditorialBoard' => false,
  'contactName' => 'Miguel Gutiérrez-Peláez, PhD.',
  'contactEmail' => 'apl@urosario.edu.co',
  'contactPhone' => '(571)3474570 Ext. 211',
  'contactFax' => '(571)3474570 Ext. 210',
  'contactMailingAddress' => 
  array (
    'es_ES' => '<p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Programa de Psicología</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Escuela de Medicina y Ciencias de la Salud</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Carrera 24 # 63 C- 69 Quinta de Mutis</p><p class="MsoNormal" style="margin: 0cm 0cm 0pt;">Bogotá, D. C. Colombia</p>',
  ),
  'supportName' => 'Luisa Ramírez',
  'supportEmail' => 'editorapl@urosario.edu.co',
  'supportPhone' => '',
  'publisherNote' => 
  array (
    'es_ES' => 'Programa de Psicología<br />Escuela de Medicina y Ciencias de la Salud',
    'en_US' => '<p>Psychology Program</p><p>School of Medicine and Health Sciences</p>',
  ),
  'sponsors' => 
  array (
    0 => 
  ...
  'envelopeSender' => 'editorapl@urosario.edu.co',
  'searchDescription' => 
  array (
    'es_ES' => 'APL publica artículos originales con contenido de carácter empírico, teórico o de revisión en profundidad en todas las áreas de la psicología',
  ),
  ...
  'searchKeywords' => 
  array (
    'es_ES' => 'PSICOLOGIA; LATINOAMERICA; SALUD; TRABAJO; EDUCACION; NEUROCIENCIAS; CIENCIAS SOCIALES; CONDUCTA; COGNICION; CONCIENCIA',
  ),
  ...
  'readerInformation' => 
  array (
    'es_ES' => 'Recomendamos a los/as lectores/as que se inscriban en el servicio de notificación de publicación de esta revista. Use el enlace de <a href="/index.php/apl/user/register">Registro</a> que se encuentra arriba en el inicio de la revista. Este registro permitirá al / a la lector/a recibir la Tabla de contenidos por correo-e cada vez que se publique un nuevo número de la revista. Esto también permitirá a la revista conseguir un cierto nivel de soporte y número de lectores/as. Consulte la <a href="/index.php/apl/about/submissions#privacyStatement">Política de Privacidad</a> de la revista, que asegura a los/as lectores/as que su nombre y dirección de correo-e no serán usados para otros propósitos.',
    'en_US' => '<p>We recommend readers to sign in the service of notice of publication of this journal. Use the Register link is found in the home icon of the journal. This registration will allow the reader to receive the Table of Contents by email each time a new issue of the magazine is published. This will also allow the journal to obtain a certain level of support and readership. See Privacy Policy of the journal, which assures the readers that their name and e-mail address will not be used for other purposes.</p>',
  ),
  'authorInformation' => 
  array (
    'es_ES' => '¿Tiene interés en hacer un envío a esta revista? Le recomendamos que revise la sección <a href="/index.php/apl/about">Acerca de la revista</a><a> para consultar la política de la misma, así como las </a><a href="/index.php/apl/about/submissions#authorGuidelines">Normas de autores/as</a>. Los/as autores/as necesitan <a href="/index.php/apl/user/register">registrarse</a> en la revista para poder hacer envíos, o si ya están registrados pueden simplemente <a href="/index.php/index/login">identificarse</a> y empezar el proceso de 5 pasos.',
    'en_US' => '<p>Are you interested in submitting an article to this journal? We recommend that you review the About the Journal section to check the journal’s policy and Author Guidelines. Authors need to register with the journal prior to submitting or, if already registered, can simply log in and begin the 5 step process.</p>',
  ),
  ...
  array (
    ...
    'en_US' => '<p>We encourage research libraries to include APL in their list of electronic journals. This publishing system is also designed to be hosted and operated by research libraries as support for the journal publishing work of their associated faculties. For more information on using Open Journal Systems to manage and publish peer-reviewed journals, see Public Knowledge Project.</p>',
  ),
  'copyrightNotice' => 
  array (
    ...
    'en_US' => '<p>Authors retain copyright and ensure the journal\'s right to be the first publication of the work as licensed under a Creative “Commons Attribution License” that allows others to share the work with an acknowledgment of authorship of the work and the initial publication in this journal.</p>',
    'pt_BR' => '<p>Os autores conservam os direitos de autor e garantem à revista o direito de ser a primeira publicação do trabalho da mesma forma que licenciado sob uma <a href="http://creativecommons.org/licenses/by-nc/4.0/">Creative Commons Attribution License</a> que permite a outros compartilhar o trabalho com um reconhecimento da autoria do trabalho e a publicação inicial nesta revista. </p>',
  ),
  'reviewGuidelines' => 
  array (
    'es_ES' => '<p>Se sugiere a los revisores tener en cuenta lo siguiente:</p><p>Los comentarios al manuscrito deben ser completos y detallados y deben contener opiniones claras acerca de las fortalezas, debilidades, relevancia, e importancia del mismo.  Se prefieren comentarios específicos que hagan referencia a secciones, páginas o párrafos.  Los comentarios deben ser constructivos y se deben ofrecer sugerencias para mejorar el manuscrito.</p><p><strong>Elementos importantes que debe tener en cuenta el revisor:</strong></p><p><strong>Contenido General</strong></p><ul><li>¿El título del artículo refleja claramente su contenido?</li><li>¿La longitud del resumen es de máximo 180 palabras?</li><li>Si es un reporte de investigación, ¿incluye resumen, justificación (estado del arte y definición del problema de investigación), objetivos, métodos, resultados y conclusiones?</li><li>¿Es la información presentada relevante para los lectores?</li><li>¿La revisión de la literatura es apropiada y actualizada?  ¿Conoce algunas referencias que el autor podría agregar y discutir? ¿La lista de referencias se hace según las normas APA? ¿Todas las referencias citadas en el texto están incluidas en la lista de referencias?</li></ul><p><strong>Aspectos técnicos</strong></p><ul><li>¿El manuscrito hace un aporte al conocimiento?</li><li>¿El manuscrito tiene relevancia teórica?</li><li>¿Las conclusiones están basadas apropiadamente en los datos?</li><li>Para investigaciones cuantitativas:</li><ul><li>¿Es el manuscrito técnicamente correcto en términos de método, procedimiento y análisis de los datos?</li><li>¿El poder estadístico de la investigación es adecuado?</li><li>¿Los hallazgos de la investigación se consideran representativos?</li><li>¿Los hallazgos de la investigación tienen validez?</li></ul><li>Para investigaciones cualitativas:</li><ul><li>¿Cumple la investigación con los criterios de transferibilidad?</li><li>¿Hay coherencia entre el modelo teórico de la investigación y la metodología cualitativa utilizada?</li></ul></ul><p><strong>Tablas y Figuras</strong></p><ul><li>¿Las figuras y las tablas son realmente necesarias? Si lo son, ¿están bien diseñadas y ayudan a entender el texto?</li><li>¿Las figuras (o fotografías) son de calidad suficientemente buena para ser reproducidas en la revista?</li></ul><p><strong>Elementos adicionales</strong></p><ul><li>¿El documento está escrito de manera fluida y se hace fácil su lectura?</li><li>¿La extensión del manuscrito es adecuada (máximo 30 páginas incluyendo todas las secciones)? ¿Hay repeticiones innecesarias?</li><li>¿El manuscrito sigue las normas de presentación de artículos de la American Psychological Association?</li></ul><p>Con base en estos elementos, y después de una revisión cuidadosa, el evaluador debe proporcionar una de las siguientes recomendaciones al Editor con respecto al manuscrito, haciendo referencia a cada uno de los ítems antes mencionados:</p><ul><li><span style="text-decoration: underline;">Aceptado sin correcciones</span>: El artículo no requiere ninguna modificación.</li><li><span style="text-decoration: underline;">Aceptado después de correcciones</span>: Se requieren algunas modificaciones o se hace necesario aclarar algunos de sus apartados.</li><li><span style="text-decoration: underline;">Reenviar a evaluación:</span> Se asignan nuevos pares evaluadores después de una revisión profunda del manuscrito por parte de los autores.</li><li><span style="text-decoration: underline;">Rechazado</span>: la calidad del manuscrito no es lo suficientemente buena para ser publicado en la revista o el manuscrito es de poco interés para los lectores de la misma.</li></ul><p> </p>',
    'en_US' => '<p>Reviewers are suggested to take the following into account:</p><p>The comments on the manuscript must be complete and detailed and should contain clear opinions about the strengths, weaknesses, relevance and importance of the article. Specific comments that refer to sections, pages or paragraphs are preferred. Comments must be constructive and should offer suggestions to improve the manuscript.</p><p><strong>Important elements the reviewer should keep in mind:</strong></p><p><strong>General Content</strong></p><ul><li>Does the title of the article clearly reflect its content?</li><li>Is the length of the abstract no more than 180 words?</li><li>If a research report, does it include summary, justification (state of the art and research problem definition), objectives, methods, results and conclusions?</li><li>Is the information presented relevant to readers?</li><li>Is the literature review is appropriate and updated? Do you know any references that the author could add and discuss? Is the list of references done according to APA standards? Are all the references cited in the text included in the list of references?</li></ul><p><strong>Technical Aspects</strong></p><ul><li>Does the manuscript make a contribution to knowledge?</li><li>Does the manuscript has theoretical relevance?</li><li>Are the conclusions based appropriately on the data?</li></ul><ul><li>For quantitative research:<ul><li>It is the manuscript technically correct in terms of method, procedure and data analysis?</li><li>Is the statistical power of this research is adequate?</li><li>Are the research findings considered representative?</li><li>Do the research findings have validity?</li></ul></li></ul><ul><li>For qualitative research:<ul><li>Does the research meet transferability criteria?</li><li>Is there consistency between the theoretical model of the research and qualitative methodology used?</li></ul></li></ul><p><strong>Tables and Figures</strong></p><ul><li>Are the figures and tables are really necessary? If they are, are they well-designed and help understanding the text?</li><li>Are the figures (or pictures) of good enough quality to be reproduced in the magazine?</li></ul><p><strong>Additional Elements</strong></p><ul><li>Is the document fluently written and is easy to read?</li><li>Is the length of the manuscript appropriate (maximum 30 pages including all the sections)? Are there unnecessary repetitions?</li><li>Does the manuscript follow the rules for articles of the American Psychological Association?</li></ul><p>Based on these elements, and after careful review, the reviewer must provide one of the following recommendations to the Editor regarding the manuscript, referring to each of the items mentioned above:</p><ul><li><span style="text-decoration: underline;">Accepted without corrections</span>: This article requires no modification.</li><li><span style="text-decoration: underline;">Accepted after corrections</span>: Some modifications are required or it is necessary to clarify some of its sections.</li><li><span style="text-decoration: underline;">Rejected</span>: the quality of the manuscript is not good enough to be published in the journal or the manuscript is of little interest to the readers of the journal.</li></ul><p> </p><p> </p><p> </p><p> </p><p> </p>',
  ),
  'metaCitations' => false,
  'metaCitationOutputFilterId' => -1,
  'privacyStatement' => 
  array (
    'es_ES' => '<span>Los nombres y direcciones de correo-e introducidos en esta revista se usarán exclusivamente para los fines declarados por esta revista y no estarán disponibles para ningún otro propósito u otra persona.  El proceso de revisión es de tipo doble ciego, se realiza de forma anónima y la única persona que conoce las identidades tanto del autor como del revisor es el editor de la revista, quien se encarga de enviar la correspondencia.</span>',
    'en_US' => '<p>The names and email addresses entered in this journal will be used exclusively for the stated purposes of this journal and will not be available for any other purpose or another person. The review process is double-blind, it is done anonymously and the only person who knows the identities of both the author and the reviewer is the editor of the journal, who is responsible for sending the correspondence.</p>',
    'pt_BR' => '<p>Os nomes e endereços de correio eletrônico introduzidos nesta revista se usarão exclusivamente para os fins declarados por esta revista e não estarão disponíveis para nenhum outro propósito ou outra pessoa. O processo de revisão é de tipo duplo cego, se realiza de forma anónima e a única pessoa que conhece as identidades tanto do autor quanto do revisor, é o editor da revista, quem se encarrega de enviara correspondência. </p>',
  ),
  'reviewPolicy' => 
  array (
    'es_ES' => '<p>El comité editorial evalúa la pertinencia de los manuscritos remitidos y verifica el cumplimiento de los requisitos solicitados en la sección <a href="/index.php/apl/about/submissions#authorGuidelines">“Directrices para los autores”</a> . Si cumple con estos requisitos, a continuación se da inicio al proceso de revisión por pares a cargo de un editor asociado, en el que es evaluado por dos especialistas en la materia.  El manuscrito debe cumplir los criterios de envío especificados para ser enviado a revisión por pares, de lo contrario, será devuelto a los autores.</p><p>Este proceso de tipo doble ciego se realiza de forma anónima y la única persona que conoce las identidades tanto del autor como del revisor es el editor de la revista, quien se encarga de enviar la correspondencia.  Los manuscritos sometidos a APL pueden ser revisados en cuanto a su originalidad utilizando algún software especializado (ej. turnitin)</p><p>La revisión inicial toma por lo general  entre 4 y 8 semanas dependiento de su adherencia a las normas de publicación especificadas por la revista. Si el manuscrito cumple todas  las condiciones de envío, el proceso de revisión por pares tiene una duración aproximada de entre 6 y 12 meses, dependiento de varios aspectos como la respuesta de los pares y la agilidad de los autores para atender a sus recomendaciones. En algunos casos, los manuscritos pueden ser enviados a una segunda ronda de revisión.</p><p>Cuando los autores deseen someter manuscritos que hayan sido rechazados por otras revistas con evaluación por pares, podrán someter junto con sus manuscritos los conceptos de revisiones anteriores. </p><p>Los procesos de revisión, evaluación por pares y publicación no acarrean costos para los autores.</p>',
    'en_US' => '<p>The editorial board assesses the relevance of manuscripts received and verifies compliance with the requirements stipulated in the “Guidelines for authors ". If the requirements are met, then the peer review process begins, with evaluation of the manuscript by two specialists in the field. This double-blind process is done anonymously and the only person who knows the identities of both the author and the reviewer is the editor of the magazine, who is responsible for sending the correspondence. The processes of revision, peer evaluation and publication do not entail costs for authors.</p>',
    'pt_BR' => '<p>O comité editorial avalia a pertinência dos manuscritos remitidos e verifica o cumprimento dos requisitos solicitados na seção “Diretrizes para os autores”. Se cumpre com estes requisitos, a continuação se dá início ao processo de revisão por pares, no que é avaliado por dois especialistas na matéria. Este processo de tipo duplo cego se realiza de forma anónima e a única pessoa que conhece as identidades tanto do autor quanto do revisor é o editor da revista, quem se encarrega de enviar a correspondência. Os processos de revisão, avaliação por pares e publicação não acarreiam custos para os autores. </p>',
  ),
  'categories' => NULL,
  'contactAffiliation' => 
  array (
...
Avances en Psicología Latinoamericana',
  ...
  'openAccessPolicy' => 
  array (
    'es_ES' => '<p>Esta revista provee acceso libre inmediato a su contenido bajo la premisa de que hacer disponible gratuitamente al público el conocimiento resultado de investigación favorece un mayor intercambio de conocimiento global.</p>',
    'en_US' => '<p>This journal provides immediate access to its content on the premise making freely available research findings to the public favors to the public favors a greater global exchange of knowledge.</p>',
    'pt_BR' => '<p>Esta revista provê acesso livre imediato a seu conteúdo sob a premissa que fazer disponível gratuitamente ao público o conhecimento resultado de investigação favorece um maior intercâmbio de conhecimento global. </p>',
  ),
  'submissionChecklist' => 
  array (
    'es_ES' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => 'El manuscríto es original e inédito. Se incluye carta de envío que autoriza la publicación del manuscrito, declara su originalidad, y da cuenta de las consideraciones éticas del caso.',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => '<p>El manuscrito es un reporte de investigación o una revisión sistemática de literatura y  sigue normas APA 6ta edición en cuanto a su estructuración, forma y contenido.</p>',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => 'El manuscrito establece con claridad su relevancia en función de la discusión de la literatura empírica pertinente. Establece su aporte y justificación.',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => '<p>El manuscrito acredita debidamente todas sus fuentes mediante la inclusión de  las citas y referencias pertinentes. </p><p>El manuscrito no contiene copia.</p>',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'Todos los autores del manuscrito participaron activamente en la elaboración del mismo',
      ),
    ),
    'en_US' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => '<p>Format</p><p>Have you reviewed the “Author Guidelines” en the APL journal’s page?  Does the manuscript meet the following requirements?</p><p>Font Times New Roman, size 12, double space the entire manuscript.</p><p>The drafting of the manuscript has been reviewed and it does not contain grammatical, spelling or format errors.</p><p>The manuscript contains all sections depending on the type of document (literature review and empirical work, theoretical article, methodological article or case study).</p><p>The sections "title page", "abstract", "appendixes", "tables" and "figures" are on separate pages (no more than a figure or table per page).</p><p>The manuscript pages are numbered according to the APA guidelines.</p>',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => '<div>The file is sent in Microsoft Word format.</div>',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => '<div>Web addresses have been added to the references where it has been possible (DOI , DOAJ or  websites).</div>',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => 'The manuscript meets the style requirements of the American Psychological Association (APA).',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'The manuscript has been prepared for peer-review, so measures have been taken to preserve the identity of the authors (does not contain personal information or metadata that might identify the authors).',
      ),
    ),
    'pt_BR' => 
    array (
      ...
      array (
        'order' => '1',
        'content' => '<p>Como parte do processo de envios, os autores estão obrigados a comprovar que seu envio cumpra todos os elementos que se mostram a continuação. Se devolverão aos autores aqueles envios que não cumpram estas diretrizes.</p><p>Formato</p><p>Tem revisado as “<a href="/index.php/apl/about/submissions#authorGuidelines" target="_blank">Diretrizes para autores</a>” na página da revista APL? Cumpre o manuscrito os seguintes requerimentos?</p><p>- Tipo de fonte Times New Roman, tamanho 12, duplo espaço em todo o manuscrito.</p><p>- A redação do manuscrito tem sido revisada e este não contém erros gramaticais, ortográficos ou de formato. </p><p>- O manuscrito contém todas as seções segundo o tipo de documento (revisão de literatura ou trabalho empírico, artigo teórico, artigo metodológico ou estudo de caso).</p><p>-As seções “página do título”, “resumo”, “apêndices”, “tabela” e “figuras” estão em páginas separadas (não mais de uma figura ou tabela por página). </p><p>-As páginas do manuscrito estão numeradas conforme às diretrizes da APA. </p>',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => 'O ficheiro enviado está em formato Microsoft Word.',
      ),
      2 => 
      array (
        'order' => '3',
        'content' => 'Se têm adicionado endereções web para as referências onde tem sido possível (DOI, DOAJ ou, em seu defeito, website.',
      ),
      3 => 
      array (
        'order' => '4',
        'content' => 'O texto cumpre com as normas de estilo da <em>American Psychological Association</em> (APA).',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'O manuscrito tem sido preparado para revisão por pares, pelo que se têm tomado as medi',
      ),
    ),
  ),
...
var _gaq = _gaq || [];
  _gaq.push([\'_setAccount\', \'UA-33272193-1\']);
...
// ]]></script>',
  ...
  array (
    'es_ES' => 'Avances en psicologia latinoamericana',
  ),
  'rtSharingEnabled' => 'on',
  'rtSharingUserName' => '',
  ...
  array (
    ...
    array (
      ...
      'width' => 327,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpLKqyOz\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:11:59',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'width' => 327,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpPVQW0L\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:11:51',
    ),
    'en_US' => 
    array (
      'name' => 'logo1.jpg',
      ...
      'width' => 327,
      'height' => 125,
      'mimeType' => 'cannot open `/tmp/phpejcIyr\' (No such file or directory)',
      'dateUploaded' => '2015-06-05 14:37:47',
    ),
  ),
  'pageHeaderTitleType' => 
  array (
  ...
  array (
    ...
    'dateUploaded' => '2011-09-01 11:10:41',
  ),
  'description' => 
  array (
    'en_US' => '<p><strong>ISSN-e:</strong> 2145-4515 <br> <strong>ISSN:</strong> 1794-4724 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/apl">http://dx.doi.org/10.12804/apl</a></p>',
    'pt_BR' => '<p><strong>ISSN-e:</strong> 2145-4515 <br> <strong>ISSN:</strong> 1794-4724 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/apl">http://dx.doi.org/10.12804/apl</a></p>',
    'es_ES' => '<p><strong>ISSN-e:</strong> 2145-4515 <br> <strong>ISSN:</strong> 1794-4724 <br> <strong>DOI:</strong> <a title="doi" href="http://dx.doi.org/10.12804/apl">http://dx.doi.org/10.12804/apl</a></p>',
  ),
  'lockssLicense' => 
  array (
    ...
    'en_US' => '<p>This journal uses the LOCKSS system to create a file distributed among the participating libraries, allowing those libraries to create permanent archives of the journal with purposes of preservation and restoration. <a href="http://www.lockss.org/"> More information…</a></p>',
  ...
  array (
    'es_ES' => '<p>Al someter un artículo a la revista Avances en Psicología Latinoamericana (APL), los autores deben informar si tienen intereses financieros, personales o profesionales que puedan influir en la información presentada en el artículo sometido.</p><p>La existencia de un conflicto de interés no significa que los autores no puedan someter el manuscrito a revisión. Si hay un conflicto de intereses, este debe ser informado al editor durante el proceso de revisión y hacerse explícito en los artículos publicados.</p><p>Los editores de la revista procurarán, en la medida de lo posible, que los pares evaluadores no tengan vínculos directos con los autores de los artículos que pudieran afectar la objetividad de la revisión. Los revisores deben también informar cualquier interés que pueda interferir con la evaluación objetiva del manuscrito.  </p>',
    'en_US' => '<p>When submitting an article to the journal Avances en Psicología Latinoamericana (APL) , authors must inform if they have financial, personal or professional interest that may influence the information presented in submitted manuscript.</p><p>The existence of a conflict of interest does not mean that authors cannot submit the manuscript for review. If there is a conflict of interest, this should be reported to the editor during the review process and made explicit in the published articles.</p><p>The editors of the magazine shall seek, to the most possible extent, that the peer reviewers do not have direct links with the authors of articles that could affect the objectivity of the review. Reviewers should also report any interest that might interfere with objective evaluation of the manuscript.</p>',
  ),
  'announcementsIntroduction' => 
  array (
    'en_US' => '<p><span>Director:</span></p><p><span>Miguel Gutiérrez-Peláez, PhD</span></p><p><span>apl@urosario.edu.co</span></p><p><span> </span></p><p><span>Editor:</span></p><p><span>Luisa Ramírez, PhD</span></p><p><span>editorapl@urosario.edu.co</span></p>',
    'es_ES' => '<p>Director APL 2016-2020:</p><p>Miguel Gutiérrez-Peláez, PhD</p><p><a href="mailto:apl@urosario.edu.co">apl@urosario.edu.co</a></p><p> </p><p>Editora general APL 2016-2020:</p><p>Luisa Ramírez, PhD</p><p><a href="mailto:editorapl@urosario.edu.co">editorapl@urosario.edu.co</a></p>',
  ),
  'journalPageFooter' => 
  array (
    'en_US' => '<p><span>ISSN: 1794-4724</span></p><p><span>ISSN-e: 2145-4515</span></p><p><span><a href="http://editorial.urosario.edu.co">Editorial</a><span class="apple-converted-space"> </span>-<span class="apple-converted-space"> </span><a href="http://biblioteca.urosario.edu.co">Biblioteca</a><span class="apple-converted-space"> </span>-<span class="apple-converted-space"> </span><a href="http://www.urosario.edu.co/aviso_legal.htm" target="_blank">Condiciones de uso y Aviso legal</a></span></p>',
  ...
  array (
    ...
    'en_US' => '<p>The submitted articles should follow the style of the <em>Publication Manual of the American Psychological Association</em> (sixth edition, 2010), regarding its formal presentation.</p><p>Besides the submitted manuscript, it is necessary to submit an authorization of publication form, which can be d<a href="/public/site/Autorizacion_publicacion_autores_2016_APL.docx">ownloaded Here</a></p><p><span class="st">A <em>completed form</em> must be signed by <em>all authors.</em></span></p><p>The editorial board assesses the relevance of the manuscripts received and verifies compliance with the requirements stipulated in the “Author Guidelines” section for authors.  If the initial examination has a positive outcome, then the peer review process begins in which manuscripts are evaluated by two experts in the field.  This double-blind process is done anonymously and the only person who knows the identities of both the author and the reviewer is the editor of the magazine, who is responsible for sending the correspondence.  The processes of revision, peer evaluation and publication do not entail costs for authors.</p><p><strong>Style and manuscript presentation: author guidelines</strong></p><ul><li><strong>Content.</strong> Original empirical and theoretical contributions and exceptionally strong literary reviews are accepted, which contribute to the advancement of Psychology as a science or as a profession. The manuscripts sent will be submitted for double blind evaluation by two peers.</li><li><strong>Ethical issues</strong>. Articles based on research involving human subjects must include a statement in the methods section in which they certify that the experiments were made with the knowledge and written consent of each of the participating subjects. When experimental animals are used, it should be explicitly mentioned in the methods section the use of appropriate measures to minimize the pain. In either case, authors should follow the ethical standards of the APA.</li><li><strong>Languages</strong>. Articles are published in Spanish, English, Portuguese and Italian, with abstracts and key words (obtained in the Thesaurus de la American Psychological Association) in Spanish and English. </li><li><strong>Style</strong>. Authors must submit their articles following the style of the <em>Publication Manual of the American Psychological Association</em> (sixth edition, 2010).  Manuscripts that do not follow these rules for submission will be returned to the authors for review. In the manuscript works must be cited by author and year, as follows: Estes (2000), Gutiérrez (1999), Ruiz, Pellón and García (2006) and Wolfgang (1997). In the references at the end of the article, all works must be cited (articles, books, book chapters, documents taken from the Internet, conference presentations, etc.), in alphabetical order by first author. For example:</li></ul><p>1. Estes, W. K. (2000). Basic methods of psychological science. En K. Pawlik &amp; M. R. Rosenzweig (Eds.), International handbook of psychology (pp. 20-39). London: SAGE.</p><p>2. Gutiérrez, G. (1999). Hormonas y reproducción en aves: la influencia de factores ambientales y sociales. Revista Latinoamericana de Psicología, 31, 151-174.</p><p>3. Ruiz, G., Pellón, R. y García, A. (2006). Análisis experimental de la conducta en España. Avances en Psicología Latinoamericana, 24, 71-103.</p><p>4. Wolfgang, A. (1997). Nonverbal behavior. Perspectives, application, intercultural insights. Seattle, WA%Guidelines[pt_BR]=<p>Os artigos submetidos à revista devem seguir as normas do Manual de Estilo de Publicações da <em>American Psychological Association</em> (Sexta edição, 2010) no que respeita a sua apresentação formal.</p><p>Para além do manuscrito, é necessário enviar autorização para publicação em formato da revista. O formulário que deve ser diligenciado e assinado por cada um dos autores do manuscrito pode ser descarregado <a href="/public/site/Autorizacion_publicacion_autores_2016_APL.docx">aqui</a></p><p>O comité editorial avalia a pertinência dos manuscritos remitidos e verifica o cumprimento dos requisitos solicitados na seção “Diretrizes para autores”. Se cumpre com estes requisitos, a continuação se dá início ao processo de revisão por pares, no que é avaliado por dois especialistas na matéria. Este processo de tipo duplo cego se realiza de forma anónima e a única pessoa que conhece as identidades tanto do autor quanto do revisor é o editor da revista, quem se encarrega de enviar a correspondência. Os processos de revisão, avaliação por pares e publicação não acarreiam custos para os autores.</p><p><br /> <strong>Forma e apresentação de manuscritos: instruções aos autores</strong></p><ul><li><strong>Conteúdo</strong>. Se aceitam trabalhos originais empíricos, teóricos ou de revisão em profundidade, que contribuam ao avanço da psicologia como ciência ou como profissão. Os artigos enviados submeteram-se a avaliação “dupla cega” por dois árbitros.</li><li><strong>Aspectos éticos</strong>. Os artigos baseados em pesquisas com seres humanos devem incluir uma declaração na seção de métodos, na que se certifique que os experimentos se fizeram com o conhecimento e o consentimento escrito de cada um dos sujeitos participantes. Quando se usem animais experimentais, deve-se fazer referência explícita na seção de Métodos ao uso de medidas apropriadas para minimizar a dor. Em ambos os casos, os autores devem seguir as normas éticas da APA.</li><li><strong>Línguas</strong>. Publicam-se artigos em espanhol, inglês, português e italiano, com resumo e palavras-chave (obtidas do <em>Thesaurus da American Psychological Association</em>) em espanhol e inglês.</li><li><strong>Forma</strong>.<strong> </strong>Os autores devem enviar seus artigos seguindo o estilo internacional em psicologia (normas da <em>American Psychological Association</em>; sexta edição, 2010). Os trabalhos que não sigam estas normas de apresentação serão devolvidos aos seus autores para ser revisados. No texto deve se citar por autor e ano. Assim: Estes (2000), Gutiérrez (1999), Ruiz, Pellón e García (2006) e Wolfgang (1997). Na lista de referências, ao final do artigo, devem-se citar todos os trabalhos (artigos, livros, capítulos de livros, materiais tomados da Internet, apresentações a congressos, etc.), em ordem alfabética do primeiro autor. Por exemplo:</li><li><strong>Figuras e tabelas</strong>. Enviar cada uma em uma página aparte. As figuras devem estar prontas para entrar em prensa, o mesmo que as fotografias, se as houvesse. Cada uma das figuras deve ser enviada em ficheiros originais.</li><li><strong>Longitude.</strong> O manuscrito deve conter máximo 30 folhas incluindo TODOS os apartes do documento.</li><li><strong>Linguagem.</strong> Usar uma linguagem “standard”, que seja o mais geral e simples possível. Evitar o uso de regionalismos ou de anglicismos que tenham um claro equivalente na língua original (em português, por exemplo: usar “prova” em vez de “test”). Devem evitar-se os sesgos da linguagem que possam resultar pejorativos ou discriminatórios.</li><li><strong>Abreviaturas: </strong>Podem se utilizar, sempre que a primeira vez se apresente a frase completa. Por exemplo: <em>Eysenck Personality Inventory</em> (EPI); depois no texto se utilizará unicamente EPI. <strong></strong></li><li><strong>Separatas.</strong> O autor receberá cópia eletrônica de seu artigo em formato PDF, para a sua distribuição unicamente com fins acadêmicos. <strong></strong></li></ul><ol start="1"><li>Estes, W. K. (2000). Basic methods of psychological science. Em K. Pawlik &amp; M. R. Rosenzweig (Eds.), International handbook of psychology (pp. 20-39). London: SAGE.</li><li>Gutiérrez, G. (1999). Hormonas y reproducción en aves: la influencia de factores ambientales y sociales. Revista Latinoamericana de Psicología, 31, 151-174.</li><li>Ruiz, G., Pellón, R. e García, A. (2006). Análisis experimental de la conducta en España. Avances en Psicología Latinoamericana, 24, 71-103.</li><li>Wolfgang, A. (1997). Nonverbal behavior. Perspectives, application, intercultural insights. Seattle, WA: Hogrefe e Huber.</li></ol><p><strong>Envio de manuscritos</strong></p><p>O material deve se enviar em formato eletrônico através da plataforma <em>Open Journal System (OJS)</em> da revista, disponível no endereço eletrônico: <strong></strong></p><p><a href="/index.php/apl/index">http://revistas.urosario.edu.co/index.php/apl/index</a></p><p>No sistema deve criar-se uma conta de usuário com o perfil do autor e se fazer  o envio do manuscrito a ser revisado.</p>',
    'es_ES' => '<p>Directrices para autores</p><p>Los artículos sometidos a la revista deben seguir las normas del Manual de Estilo de Publicaciones de la American Psychological Association (Sexta edición, 2010) en lo que respecta a su presentación formal.</p><p>Además del manuscrito, que debe ser original e inédito, es necesario diligenciar el formato de  autorización para publicación en formato de la revista. El formulario  debe ser diligenciado y firmado por cada uno de los autores del manuscrito <a href="/public/site/Autorizacion_publicacion_autores_2016_APL.docx">Clic Aquí</a> para descargar el archivo.</p><p>El comité editorial evalúa la pertinencia de los manuscritos remitidos y verifica el cumplimiento de los requisitos solicitados en la sección “Directrices para autores”. Si cumple con estos requisitos, a continuación se da inicio al proceso de revisión por pares, en el que es evaluado por dos especialistas en la materia. Este proceso de tipo doble ciego se realiza de forma anónima y la única persona que conoce las identidades tanto del autor como del revisor es el editor de la revista, quien se encarga de enviar la correspondencia.  Los procesos de revisión, evaluación por pares y publicación no acarrean costos para los autores.</p><p><br /> <strong>Forma y presentación de manuscritos: instrucciones a los autores</strong></p><ul><li><strong>Contenido</strong>. Se aceptan trabajos originales e inéditos de caracter empírico, teórico o revisiones sistemáticas principalmente, que contribuyan al avance de la psicología como ciencia o como profesión. Los artículos enviados se someterán a evaluación “doble ciego” por dos árbitros.</li><li><strong>Aspectos éticos</strong>. Los artículos basados en investigaciones con seres humanos deben incluir una declaración en la sección de métodos en la que se certifique que los experimentos se hicieron con el conocimiento y el consentimiento escrito de cada uno de los sujetos participantes. Cuando se usen animales experimentales, se debe hacer referencia explícita en la sección de métodos al uso de medidas apropiadas para minimizar el dolor. En uno y otro caso, los autores deben seguir las normas éticas de la APA. Siempre que sea posible debe incluir en el envío, como archivo complementario, la carta de aval o aprobación del Comité de ética o de investigaciones que haya evaluado la propuesta en sus aspectos éticos.</li><li><strong>Idiomas</strong>. Se publican artículos en español, inglés y portugués con resumen y palabras clave (obtenidas del <em>Thesaurus de la American Psychological Association</em>) en el idioma original e inglés.</li><li><strong>Forma</strong>. Los autores deben enviar sus artículos siguiendo el estilo internacional en psicología (normas de la <em>American Psychological Association</em>, sexta edición, 2010). Los trabajos que no sigan estas normas de presentación serán devueltos a sus autores para ser revisados. En el texto debe citarse por autor y año. Así: Estes (2000), Gutiérrez (1999), Ruiz, Pellón y García (2006) y Wolfgang (1997). En la lista de referencias, al final del artículo, se deben citar todos los trabajos (artículos, libros, capítulos de libros, materiales tomados de Internet, presentaciones a congresos, etc.), en orden alfabético del primer autor. Por ejemplo:</li></ul><ol><li>Estes, W. K. (2000). Basic methods of psychological science. En K. Pawlik &amp; M. R. Rosenzweig (Eds.), International handbook of psychology (pp. 20-39). London: SAGE.</li><li>Gutiérrez, G. (1999). Hormonas y reproducción en aves: la influencia de factores ambientales y sociales. Revista Latinoamericana de Psicología, 31, 151-174.</li><li>Ruiz, G., Pellón, R. y García, A. (2006). Análisis experimental de la conducta en España. Avances en Psicología Latinoamericana, 24, 71-103.</li><li>Wolfgang, A. (1997). Nonverbal behavior. Perspectives, application, intercultural insights. Seattle, WA: Hogrefe y Huber.</li></ol><ul><li><strong>Figuras y tablas</strong>. Incluir al final del manuscrito (como anexo) las tablas y figuras que se deban incluir en la publicación. Cada una, en página aparte. Las figuras deben estar listas para entrar en prensa, lo mismo que las fotografías, si las hubiera.</li></ul><ul><li><strong>Longitud.</strong> El manuscrito debe contener máximo 30 hojas incluyendo TODOS los apartes del documento (menos la página del título que identifica a los autores).</li></ul><ul><li><strong>Lenguaje</strong>. Usar un lenguaje “estándar”, que sea lo más general y sencillo posible. Evitar el uso de regionalismos o de anglicismos que tengan un claro equivalente en el idioma original (en castellano, por ejemplo: usar “prueba” en vez de “test”).  Deben evitarse los sesgos del lenguaje que puedan resultar peyorativos o discriminatorios.</li></ul><ul><li><strong>Abreviaturas</strong>. Pueden utilizarse, siempre que la primera vez se presente la frase completa. Por ejemplo: <em>Eysenck Personality Inventory</em> (EPI); después en el texto se utilizará únicamente EPI.</li></ul><ul><li><strong>Separatas</strong>. El autor recibirá copia electrónica de su artículo en formato PDF, para su distribución únicamente con fines académicos.</li></ul><p><br /> <strong>Envío de manuscritos</strong><br /> El material debe enviarse en formato electrónico a través de la plataforma <em>Open Journal System</em> (OJS) de la revista, disponible en la dirección electrónica:</p><p><a href="/index.php/apl/index">http://revistas.urosario.edu.co/index.php/apl/index</a></p><p>En el sistema debe crearse una cuenta de usuario con el perfil de autor y hacerse el envío del manuscrito a ser revisado.</p><p><strong>En archivos complementarios se deben subir:</strong></p><ul><li>Página de la portada con los datos de identificación de todos los autores</li><li>Carta de autorización para publicación y declaración de originalidad. Si son varios autores, pueden subirlas separadamente o en conjunto según su conveniencia.</li><li>Bases de datos, y otros archivos complementarios cuando los haya.</li></ul>',
  ),
...
<p>Maria Margarita Villota, Colombia</p>
</div>',
    'es_ES' => '<div id="group">
<h4>Director</h4>
...
<h4>Editores Asociados</h4>
<p>Dra. Mónica Roncancio Moreno, Pontificia Universidad Javeriana, Colombia</p>
<p>Doutora Marília Pinheiro de Carvalho</p>
...
<h4>Asistente editorial</h4>
<p>Maria Margarita Villota, Universidad del Rosario, Colombia</p>
</div>',
    'pt_BR' => '<div id="group">
<h4>Director</h4>
<p>Dr. Miguel Gutiérrez-Peláez, Colombia</p>
