<?php return array (
  ...
  'readerInformation' => 
  array (
    'es_ES' => 'Animamos a los lectores a registrarse en el servicio de notificación de publicaciones de la revista. Use el enlace <a href="/index.php/crai/user/register">Registro</a> situado en la parte superior de la página de inicio de la revista. Como resultado del registro, el lector/a recibirá por correo electrónico la Tabla de contenidos de cada número de la revista. Esta lista también permite que se le atribuya a la revista un cierto nivel de apoyo o número de lectores. Lea la<a href="/index.php/crai/about/submissions#privacyStatement">Declaración de Privacidad</a> de la revista, donde se asegura a los lectores que ni su nombre ni su correo electrónico serán usados con otros fines.',
  ),
  'authorInformation' => 
  array (
    'es_ES' => '¿Desea realizar un envío a la revista? Le recomendamos que revise las políticas específicas para cada sección de la revista en <a href="/index.php/crai/about">Acerca de la revista</a>, así como en las <a href="/index.php/crai/about/submissions#authorGuidelines">Pautas para el autor</a>. Los autores deben <a href="/index.php/crai/user/register">registrarse</a> en la revista antes de enviar un texto o, si ya están registrados, pueden simplemente <a href="/index.php/index/login">conectarse</a> y empezar el proceso de envío en cinco pasos.',
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => 'El envío no ha sido publicado previamente ni se ha sometido a consideración por ninguna otra revista (o se ha proporcionado una explicación al respecto en los Comentarios al editor).',
      ),
      1 => 
      array (
        'order' => '2',
      ...
      array (
        'order' => '4',
        'content' => 'El texto tiene un interlineado sencillo, un tamaño fuente de 12 puntos, se utiliza cursiva en lugar de subrayado (excepto en las direcciones URL), y todas las ilustraciones, figuras y tablas se encuentran colocadas en los lugares del texto apropiados, en vez de al final.',
      ),
      4 => 
      array (
        'order' => '5',
        'content' => 'El texto reúne las condiciones estilísticas y bibliográficas incluidas en <a href="/index.php/crai/about/submissions#authorGuidelines" target="_new">Pautas para el autor</a>, en Acerca de la revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'En el caso de enviar el texto a la sección de evaluación por pares, se siguen las instrucciones incluidas en <a href="javascript:openHelp(\'http://revistas.urosario.edu.co/index.php/crai/help/view/editorial/topic/000044\')">Asegurar una Evaluación a ciegas</a>.',
      ),
    ),
  ),
  'rtAbstract' => true,
  ...
  'description' => 
  array (
    'es_ES' => 'Revista de prueba del sistema, para entrenamiento y capacitación.',
  ),
  'acronym' => 
  array (
    'es_ES' => 'CRAI',
  ...
  'contactName' => 'CRAI',
  'contactEmail' => 'webiblioteca@urosario.edu.co',
  'contactPhone' => '',
  'contactFax' => '',
