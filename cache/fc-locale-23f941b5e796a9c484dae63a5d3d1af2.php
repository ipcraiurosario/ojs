<?php return array (
  ...
  'manager.navigationMenus.form.pathRegEx' => 'El campo camino debe contener únicamente caracteres alfanuméricos, así como \'.\', \'/\', \'-\', y \'_\'.',
  ...
  'manager.navigationMenus.assignedMenuItems' => 'Ítems asignados al menú',
  'manager.navigationMenus.unassignedMenuItems' => 'Ítems no asignados al menú',
  ...
  'manager.navigationMenus.about.description' => 'Enlace a una página mostrando el contenido de Acerca de la revista en Ajustes > Revista',
  ...
  'manager.navigationMenus.editorialTeam.description' => 'Enlace a una página mostrándo el contenido de la cabecera en Ajustes > Revista',
  ...
  'settings.roles.recommendOnly' => 'Este rol solo puede recomendar una decisión de revisión, necesita que un editor autorizado registre una decisión final.',
  ...
  'plugins.importexport.common.error.duplicateRevisionForSubmission' => 'La revisión "{$revisionId}" para el archivo enviado "{$fileId}" crearía un registro duplicado.',
  ...
  'manager.navigationMenus.search.description' => 'Enlazar con la página de búsqueda.',
