...
<p>2. Se debe crear un directorio editable para almacenar los archivos cargados (véase "Ajustes de archivo" más abajo).</p>',
  ...
  'common.publishedSubmission' => 'Artículo',
  'common.publishedSubmissions' => 'Artículos',
  'user.register.form.missingContextConsent' => 'Debe aceptar la declaración de privacidad de cualquier diario con el que se esté registrando.',
  'user.register.form.missingSiteConsent' => 'Debe aceptar la declaración de privacidad de este sitio.',
  'user.register.form.privacyConsentThisContext' => 'Sí, acepto que mis datos se recopilen y almacenen de acuerdo con la <a href="{$privacyUrl}" target="_blank"> declaración de privacidad </a> de esta revista.',
  'section.policy' => 'Política de la sección',
  'about.onlineSubmissions.submitToSection' => 'Realice un nuevo envío a la sección <a href="{$url}"> {$ name} </a>.',
  'catalog.sortBy' => 'Orden de articulos',
  'catalog.sortBy.categoryDescription' => 'Elija cómo ordenar artículos en esta categoría.',
  'article.qr' => 'Escanee aquí para descargar',
); ?>