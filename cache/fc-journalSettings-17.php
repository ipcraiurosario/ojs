<?php return array (
  ...
  'boardEnabled' => true,
  'categories' => NULL,
  'contactEmail' => 'carlos.reyes@urosario.edu.co',
  'contactFax' => '',
...
https://revistas.urosario.edu.co/index.php/RDC',
  ...
  'name' => 
  array (
    'en_US' => 'Advances in Science',
    'es_ES' => 'Divulgación Científica',
  ),
  'abbreviation' => 
  array (
    'es_ES' => 'Divulgación Científica',
  ...
  'authorInformation' => 
  array (
    'es_ES' => '¿Está interesado en publicar en la revista? Se recomienda revisar la página <a href="/index.php/RDC/about">Acerca de la revista</a> para consultar las políticas de sección de la revista, así como las <a href="/index.php/RDC/about/submissions#authorGuidelines">Directrices del autor/a</a>. Los autores/as deben <a href="/index.php/RDC/user/register">registrarse</a> en la revista antes de publicar o, si ya están registrados, pueden simplemente <a href="/index.php/index/login">iniciar sesión</a> y comenzar el proceso de cinco pasos.',
  ),
  ...
  array (
    'es_ES' => 'Toda donación será gratamente recibida y se empleará en proporcionar recursos a los editores/as para seguir ofreciendo a los lectores/as una revista de alta calidad.',
  ),
  'donationFeeName' => 
  array (
  ...
  array (
    'es_ES' => 'Con el pago de esta cuota, se garantiza que la revisión, la decisión editorial y la notificación al autor/a del manuscrito tendrán lugar dentro de un plazo de 4 semanas.',
  ),
  'fastTrackFeeName' => 
  array (
  ...
  'lockssLicense' => 
  array (
    'es_ES' => 'Esta revista utiliza el sistema LOCKSS para crear un sistema de archivo distribuido entre bibliotecas colaboradoras, a las que permite crear archivos permanentes de la revista con fines de conservación y restauración. <a href="http://lockss.org/">Más...</a>',
  ),
  ...
  'readerInformation' => 
  array (
    'es_ES' => 'Animamos a los lectores/as a registrarse en el servicio de notificación de publicaciones de la revista. Utilice el enlace <a href="/index.php/RDC/user/register">Registro</a> de la parte superior de la página de inicio de la revista. Como resultado del registro, el lector/a recibirá por correo electrónico la Tabla de contenidos de cada número de la revista. Esta lista también permite que se le atribuya a la revista un cierto nivel de apoyo o número de lectores/as. Consulte la <a href="/index.php/RDC/about/submissions#privacyStatement">Declaración de privacidad</a> de la revista, que garantiza a los lectores/as que sus nombres y direcciones de correo electrónico no se usarán con otros fines.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  'searchDescription' => 
  array (
    'es_ES' => 'Revista Divulgación Científica es una compilación de artículos investigativos realizados por la Universidad del Rosario.',
  ),
  'searchKeywords' => 
  array (
    'es_ES' => 'Revista;Divulgación;Científica;Investigación;Universidad;Rosario',
  ),
  'submissionFeeDescription' => 
  array (
    'es_ES' => 'Los autores/as deben pagar una cuota de envío del artículo como parte del proceso de envío para contribuir con los costes de revisión.',
  ),
  'submissionFeeName' => 
  array (
  ...
  'waiverPolicy' => 
  array (
    'es_ES' => 'En caso de no disponer de fondos para pagar dichas cuotas, existe la posibilidad de eximirse del pago. El impago de las cuotas no impedirá la publicación de aquellas obras que lo merezcan.',
  ),
); ?>