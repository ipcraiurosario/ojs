<?php return array (
  ...
  array (
    'es_ES' => 
    array (
      'name' => 'ColegioMayor.jpg',
      'uploadName' => 'homeHeaderTitleImage_es_ES.jpg',
      'width' => 411,
      'height' => 124,
      'mimeType' => 'cannot open `/tmp/phpMT5ZxD\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:16:36',
    ),
  ),
  'pageHeaderTitleType' => 
  array (
...
http://revistas.urosario.edu.co/index.php/UR',
  ...
  'authorInformation' => 
  array (
    'es_ES' => '¿Tiene interés en hacer un envío a esta revista? Le recomendamos que revise la sección <a href="/index.php/UR/about">Acerca de la revista</a><a> para consultar la política de la misma, así como las </a><a href="/index.php/UR/about/submissions#authorGuidelines">Normas de autores</a>. Los autores necesitan <a href="/index.php/UR/user/register">registrarse</a> en la revista para poder hacer envíos, o si ya están registrados pueden simplemente <a href="/index.php/index/login">identificarse</a> y empezar el proceso de 5 pasos.',
  ),
  'supportedLocales' => 
  array (
    0 => 'en_US',
  ...
  'name' => 
  array (
    'es_ES' => 'Revista del Colegio Mayor de Nuestra Señora del Rosario',
  ),
  'acronym' => 
  array (
    'es_ES' => 'UR',
  ...
  'contactName' => 'Luis Enrique Nieto Arango',
  'contactAffiliation' => 
  array (
    'es_ES' => 'Unidad de Patrimonio Cultural e Histórico',
  ),
  'contactEmail' => 'urevista@urosario.edu.co',
  'contactPhone' => '2970200 extensión: 314',
  'contactFax' => '',
  'contactMailingAddress' => 
  array (
    'es_ES' => '<p>Calle 14 No. 6-25</p>',
  ),
...
El tercer párrafo no está justificado.</pre>',
  ...
  'searchKeywords' => 
  array (
    'es_ES' => 'UNIVERSIDAD DEL ROSARIO; REVISTA DEL ROSARIO; 1905; ANTIGUA; MEJORES UNIVERSIDADES; BOGOTA; COLOMBIA',
  ),
  'customHeaders' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => 'El envío no ha sido publicado previamente ni se ha enviado previamente a otra revista (o se ha proporcionado una explicación en Comentarios al editor).',
      ),
      1 => 
      array (
        'order' => '2',
      ...
      array (
        'order' => '5',
        'content' => 'El texto cumple con los requisitos bibliográficos y de estilo indicados en las <a href="/index.php/UR/about/submissions#authorGuidelines">Normas para autores</a>, que se pueden encontrar en Acerca de la revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'Si esta enviando a una sección de la revista que se revisa por pares, tiene que asegurase que las instrucciones en <a href="javascript:openHelp(\'http://revistas.urosario.edu.co/index.php/UR/help/view/editorial/topic/000044\')">Asegurando de una revisión a ciegas</a>) han sido seguidas.',
      ),
    ),
  ),
  'copyrightNotice' => 
  array (
    'es_ES' => 'Los autores conservan los derechos de autor y garantizan a la revista el derecho de ser la primera publicación del trabajo al igual que licenciado bajo una <a href="http://creativecommons.org/licenses/by/3.0/" target="_new">Creative Commons Attribution License</a> que permite a otros compartir el trabajo con un reconocimiento de la autoría del trabajo y la publicación inicial en esta revista.<br />',
  ),
  ...
  'copySubmissionAckAddress' => 'karol.hernandez@urosario.edu.co',
  'authorGuidelines' => 
  array (
    'es_ES' => '<p>Textos con lenguaje ágil y de fácil acceso: En resumen, el articulista debe estar muy consciente de que escribe para diez o doce mil posibles lectores con formación académica y profesional disímiles.</p><p>El articulista puede pertenecer o no a la comunidad rosarista. Se recomienda identificar su texto con nombre, teléfono, dirección de correo electrónico, facultad, dependencia o actividad.</p><p>Tema: se reciben artículos de interés general <br />Extensión: Máximo 7 páginas, en letra Times New Roman, 12 puntos.</p><p>Eventualmente, la Revista hace pública una convocatoria con la que define un tipo de artículos para cada número. El articulista debería ajustarse a ella.</p>',
  ),
  ...
  'lockssLicense' => 
  array (
    'es_ES' => 'Esta revista utiliza el sistema LOCKSS para crear un archivo distribuido entre las bibliotecas participante, permitiendo a dichas bibliotecas crear archivos permanentes de la revista con fines de preservación y restauración. <a href="http://lockss.org">Ampliar información...</a>',
  ),
  ...
  array (
    ...
    array (
      ...
      'width' => 411,
      'height' => 124,
      'mimeType' => 'cannot open `/tmp/phphZNp9u\' (No such file or directory)',
      'dateUploaded' => '2015-05-29 11:16:43',
    ),
  ),
  'homeHeaderTitle' => 
  array (
  ...
  'pageHeaderTitle' => 
  array (
    'es_ES' => 'REVISTA DEL COLEGIO MAYOR NUESTRA SEÑORA DEL ROSARIO',
  ),
  ...
  'searchDescription' => 
  array (
    'es_ES' => 'La revista de la Universidad del Rosario es la revista unversitaria institucional más antigua del país. Desde 1905 da a conocer el pensamiento de la comunidad rosarista acerca de los destinos de la nación colombiana.',
  ),
  ...
  'description' => 
  array (
    'es_ES' => '<div id="journal_Des" class="tab-content"><div id="journalDescription" class="tab-pane fade in active row"><table width="779" border="0"><tbody><tr><td width="158"><a href="/index.php/ur"><img src="/imagenes/modelo_ur.jpg" alt="" width="100" height="134" border="0" /></a></td><td width="488"><div><p>La Revista del Rosario es la publicación institucional universitaria más antigua del país. Desde 1905 y sin interrupciones sus páginas reflejan los personajes, los temas y debates centrales que atañen a la Comunidad Rosarista, la comunidad protagonista de la formación de la República en Colombia.</p></div></td><td width="119"> </td></tr><tr><td height="2"> </td><td> </td><td> </td></tr></tbody></table></div><div id="journalMetrics" class="tab-pane fade"><div class="row"><div id="googlescholar" class="col-sm-4"> </div><div id="plumx" class="col-sm-4"><a class="plumx-group" href="https://plu.mx/urosario/g/cd-2/journals/issn-01203975" data-no-description="true" data-no-researchers="true" data-no-artifacts="true" data-no-logo="true" data-site="urosario" data-num-artifacts="5" data-width="400" data-gp="urosario/cd-2/journals/issn-01203975">Revista del Colegio Mayor de Nuestra Señora del Rosario Profile on PlumX</a><script type="text/javascript" src="https://d39af2mgp1pqhg.cloudfront.net/widget-group.js"></script></div><div id="scimago" class="col-sm-4"> </div></div></div></div>',
  ),
  'journalPageFooter' => 
  array (
